 ...
 * @property {boolean} allowlist - Whether or not to include ONLY the addresses or include all EXCEPT the addresses.
 ...
 * @property {boolean} useCreatorAddressAsLeaf - Whether or not to override any leaf value and use the creator address as the leaf. Used for allowlist trees.
