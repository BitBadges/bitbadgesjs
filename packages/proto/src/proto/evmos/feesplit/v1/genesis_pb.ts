...
// @generated from file evmos/feesplit/v1/genesis.proto (package evmos.feesplit.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message evmos.feesplit.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
   ...
   *
   * @generated from field: repeated evmos.feesplit.v1.FeeSplit fee_splits = 2;
   */
  feeSplits: FeeSplit[] = [];
  ...
  static readonly typeName = "evmos.feesplit.v1.GenesisState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "params", kind: "message", T: Params },
    { no: 2, name: "fee_splits", kind: "message", T: FeeSplit, repeated: true },
  ]);
 ...
 *
 * @generated from message evmos.feesplit.v1.Params
 */
export class Params extends Message<Params> {
  /**
   * enable_fee_split defines a parameter to enable the feesplit module
   *
   * @generated from field: bool enable_fee_split = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "evmos.feesplit.v1.Params";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "enable_fee_split", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
