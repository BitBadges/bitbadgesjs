...
export namespace bitbadges.bitbadgeschain.badges {
  ...
  export class CollectionApprovedTransferTimeline extends pb_1.Message {
    ...
    get collectionApprovedTransfers() {
      return pb_1.Message.getRepeatedWrapperField(this, dependency_2.bitbadges.bitbadgeschain.badges.CollectionApprovedTransfer, 1) as dependency_2.bitbadges.bitbadgeschain.badges.CollectionApprovedTransfer[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.collectionApprovedTransfers.length)
        writer.writeRepeatedMessage(1, this.collectionApprovedTransfers, (item: dependency_2.bitbadges.bitbadgeschain.badges.CollectionApprovedTransfer) => item.serialize(writer));
      if (this.timelineTimes.length)
        writer.writeRepeatedMessage(2, this.timelineTimes, (item: dependency_3.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      if (!w)
        return writer.getResultBuffer();
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CollectionApprovedTransferTimeline {
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.collectionApprovedTransfers, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.bitbadges.bitbadgeschain.badges.CollectionApprovedTransfer.deserialize(reader), dependency_2.bitbadges.bitbadgeschain.badges.CollectionApprovedTransfer));
            break;
          case 2:
            reader.readMessage(message.timelineTimes, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_3.bitbadges.bitbadgeschain.badges.UintRange.deserialize(reader), dependency_3.bitbadges.bitbadgeschain.badges.UintRange));
            break;
