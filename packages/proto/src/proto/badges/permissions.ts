...
export namespace bitbadges.bitbadgeschain.badges {
  ...
  export class CollectionApprovalPermission extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      amountTrackerIdOptions?: ValueOptions;
    ...
    set amountTrackerIdOptions(value: ValueOptions) {
    ...
    static fromObject(data: {
      ...
      amountTrackerIdOptions?: ReturnType<typeof ValueOptions.prototype.toObject>;
      ...
      if (data.amountTrackerIdOptions != null) {
        message.amountTrackerIdOptions = ValueOptions.fromObject(data.amountTrackerIdOptions);
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_amountTrackerIdOptions)
        writer.writeMessage(17, this.amountTrackerIdOptions, () => this.amountTrackerIdOptions.serialize(writer));
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 16:
            ...
            break;
          case 17:
            reader.readMessage(message.amountTrackerIdOptions, () => message.amountTrackerIdOptions = ValueOptions.deserialize(reader));
            break;
          case 18:
