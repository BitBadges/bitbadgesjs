...
export namespace badges {
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_4.badges.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_4.badges.Params, 1) as dependency_4.badges.Params;
        }
        set params(value: dependency_4.badges.Params) {
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_4.badges.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_4.badges.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_4.badges.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGetCollectionResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            collection?: dependency_5.badges.BadgeCollection;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get collection() {
            return pb_1.Message.getWrapperField(this, dependency_5.badges.BadgeCollection, 1) as dependency_5.badges.BadgeCollection;
        }
        set collection(value: dependency_5.badges.BadgeCollection) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_collection() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            collection?: ReturnType<typeof dependency_5.badges.BadgeCollection.prototype.toObject>;
        }): QueryGetCollectionResponse {
            const message = new QueryGetCollectionResponse({});
            if (data.collection != null) {
                message.collection = dependency_5.badges.BadgeCollection.fromObject(data.collection);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGetCollectionResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.collection, () => message.collection = dependency_5.badges.BadgeCollection.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGetBalanceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            balance?: dependency_7.badges.UserBalanceStore;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get balance() {
            return pb_1.Message.getWrapperField(this, dependency_7.badges.UserBalanceStore, 1) as dependency_7.badges.UserBalanceStore;
        }
        set balance(value: dependency_7.badges.UserBalanceStore) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_balance() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            balance?: ReturnType<typeof dependency_7.badges.UserBalanceStore.prototype.toObject>;
        }): QueryGetBalanceResponse {
            const message = new QueryGetBalanceResponse({});
            if (data.balance != null) {
                message.balance = dependency_7.badges.UserBalanceStore.fromObject(data.balance);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGetBalanceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.balance, () => message.balance = dependency_7.badges.UserBalanceStore.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGetAddressMappingResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            mapping?: dependency_8.badges.AddressMapping;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get mapping() {
            return pb_1.Message.getWrapperField(this, dependency_8.badges.AddressMapping, 1) as dependency_8.badges.AddressMapping;
        }
        set mapping(value: dependency_8.badges.AddressMapping) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_mapping() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            mapping?: ReturnType<typeof dependency_8.badges.AddressMapping.prototype.toObject>;
        }): QueryGetAddressMappingResponse {
            const message = new QueryGetAddressMappingResponse({});
            if (data.mapping != null) {
                message.mapping = dependency_8.badges.AddressMapping.fromObject(data.mapping);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGetAddressMappingResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.mapping, () => message.mapping = dependency_8.badges.AddressMapping.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGetApprovalsTrackerRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.amountTrackerId.length)
                writer.writeString(1, this.amountTrackerId);
    ...
    export class QueryGetApprovalsTrackerResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            tracker?: dependency_7.badges.ApprovalsTracker;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get tracker() {
            return pb_1.Message.getWrapperField(this, dependency_7.badges.ApprovalsTracker, 1) as dependency_7.badges.ApprovalsTracker;
        }
        set tracker(value: dependency_7.badges.ApprovalsTracker) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_tracker() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            tracker?: ReturnType<typeof dependency_7.badges.ApprovalsTracker.prototype.toObject>;
        }): QueryGetApprovalsTrackerResponse {
            const message = new QueryGetApprovalsTrackerResponse({});
            if (data.tracker != null) {
                message.tracker = dependency_7.badges.ApprovalsTracker.fromObject(data.tracker);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGetApprovalsTrackerResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.tracker, () => message.tracker = dependency_7.badges.ApprovalsTracker.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
