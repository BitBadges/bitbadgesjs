...
export namespace badges {
    export class BadgesPacketData extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new BadgesPacketData({});
            if (data.noData != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): BadgesPacketData {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new BadgesPacketData();
        ...
        static deserializeBinary(bytes: Uint8Array): BadgesPacketData {
            return BadgesPacketData.deserialize(bytes);
        }
    }
