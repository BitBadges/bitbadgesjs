...
export namespace bitbadges.bitbadgeschain.badges {
  export class UserBalanceStore extends pb_1.Message {
    ...
    get approvedOutgoingTransfersTimeline() {
      return pb_1.Message.getRepeatedWrapperField(this, UserApprovedOutgoingTransferTimeline, 2) as UserApprovedOutgoingTransferTimeline[];
    }
    set approvedOutgoingTransfersTimeline(value: UserApprovedOutgoingTransferTimeline[]) {
      pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    get approvedIncomingTransfersTimeline() {
      return pb_1.Message.getRepeatedWrapperField(this, UserApprovedIncomingTransferTimeline, 3) as UserApprovedIncomingTransferTimeline[];
    }
    set approvedIncomingTransfersTimeline(value: UserApprovedIncomingTransferTimeline[]) {
    ...
    static fromObject(data: {
      ...
      approvedOutgoingTransfersTimeline?: ReturnType<typeof UserApprovedOutgoingTransferTimeline.prototype.toObject>[];
      approvedIncomingTransfersTimeline?: ReturnType<typeof UserApprovedIncomingTransferTimeline.prototype.toObject>[];
      ...
      if (data.approvedOutgoingTransfersTimeline != null) {
        message.approvedOutgoingTransfersTimeline = data.approvedOutgoingTransfersTimeline.map(item => UserApprovedOutgoingTransferTimeline.fromObject(item));
      }
      if (data.approvedIncomingTransfersTimeline != null) {
        message.approvedIncomingTransfersTimeline = data.approvedIncomingTransfersTimeline.map(item => UserApprovedIncomingTransferTimeline.fromObject(item));
      }
    ...
    toObject() {
      ...
      if (this.approvedOutgoingTransfersTimeline != null) {
        data.approvedOutgoingTransfersTimeline = this.approvedOutgoingTransfersTimeline.map((item: UserApprovedOutgoingTransferTimeline) => item.toObject());
      }
      if (this.approvedIncomingTransfersTimeline != null) {
        data.approvedIncomingTransfersTimeline = this.approvedIncomingTransfersTimeline.map((item: UserApprovedIncomingTransferTimeline) => item.toObject());
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.approvedOutgoingTransfersTimeline.length)
        writer.writeRepeatedMessage(2, this.approvedOutgoingTransfersTimeline, (item: UserApprovedOutgoingTransferTimeline) => item.serialize(writer));
      if (this.approvedIncomingTransfersTimeline.length)
        writer.writeRepeatedMessage(3, this.approvedIncomingTransfersTimeline, (item: UserApprovedIncomingTransferTimeline) => item.serialize(writer));
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            reader.readMessage(message.approvedOutgoingTransfersTimeline, () => pb_1.Message.addToRepeatedWrapperField(message, 2, UserApprovedOutgoingTransferTimeline.deserialize(reader), UserApprovedOutgoingTransferTimeline));
            break;
          case 3:
            reader.readMessage(message.approvedIncomingTransfersTimeline, () => pb_1.Message.addToRepeatedWrapperField(message, 3, UserApprovedIncomingTransferTimeline.deserialize(reader), UserApprovedIncomingTransferTimeline));
            break;
          case 4:
  ...
  export class UserApprovedOutgoingTransferTimeline extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      timelineTimes?: dependency_4.bitbadges.bitbadgeschain.badges.UintRange[];
    }) {
      super();
    ...
    get approvedOutgoingTransfers() {
      return pb_1.Message.getRepeatedWrapperField(this, UserApprovedOutgoingTransfer, 1) as UserApprovedOutgoingTransfer[];
    }
    set approvedOutgoingTransfers(value: UserApprovedOutgoingTransfer[]) {
      pb_1.Message.setRepeatedWrapperField(this, 1, value);
    }
    get timelineTimes() {
      return pb_1.Message.getRepeatedWrapperField(this, dependency_4.bitbadges.bitbadgeschain.badges.UintRange, 2) as dependency_4.bitbadges.bitbadgeschain.badges.UintRange[];
    }
    set timelineTimes(value: dependency_4.bitbadges.bitbadgeschain.badges.UintRange[]) {
      pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
      approvedOutgoingTransfers?: ReturnType<typeof UserApprovedOutgoingTransfer.prototype.toObject>[];
      timelineTimes?: ReturnType<typeof dependency_4.bitbadges.bitbadgeschain.badges.UintRange.prototype.toObject>[];
      ...
      if (data.timelineTimes != null) {
        message.timelineTimes = data.timelineTimes.map(item => dependency_4.bitbadges.bitbadgeschain.badges.UintRange.fromObject(item));
      }
      return message;
    }
    toObject() {
      ...
      if (this.timelineTimes != null) {
        data.timelineTimes = this.timelineTimes.map((item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.toObject());
      }
      return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.approvedOutgoingTransfers.length)
        writer.writeRepeatedMessage(1, this.approvedOutgoingTransfers, (item: UserApprovedOutgoingTransfer) => item.serialize(writer));
      if (this.timelineTimes.length)
        writer.writeRepeatedMessage(2, this.timelineTimes, (item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      if (!w)
        return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UserApprovedOutgoingTransferTimeline {
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.approvedOutgoingTransfers, () => pb_1.Message.addToRepeatedWrapperField(message, 1, UserApprovedOutgoingTransfer.deserialize(reader), UserApprovedOutgoingTransfer));
            break;
          case 2:
            reader.readMessage(message.timelineTimes, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_4.bitbadges.bitbadgeschain.badges.UintRange.deserialize(reader), dependency_4.bitbadges.bitbadgeschain.badges.UintRange));
            break;
          default: reader.skipField();
        }
      }
  ...
  export class UserApprovedIncomingTransferTimeline extends pb_1.Message {
    ...
    get approvedIncomingTransfers() {
      return pb_1.Message.getRepeatedWrapperField(this, UserApprovedIncomingTransfer, 1) as UserApprovedIncomingTransfer[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.approvedIncomingTransfers.length)
        writer.writeRepeatedMessage(1, this.approvedIncomingTransfers, (item: UserApprovedIncomingTransfer) => item.serialize(writer));
      if (this.timelineTimes.length)
        writer.writeRepeatedMessage(2, this.timelineTimes, (item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      if (!w)
        return writer.getResultBuffer();
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UserApprovedIncomingTransferTimeline {
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.approvedIncomingTransfers, () => pb_1.Message.addToRepeatedWrapperField(message, 1, UserApprovedIncomingTransfer.deserialize(reader), UserApprovedIncomingTransfer));
            break;
          case 2:
            reader.readMessage(message.timelineTimes, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_4.bitbadges.bitbadgeschain.badges.UintRange.deserialize(reader), dependency_4.bitbadges.bitbadgeschain.badges.UintRange));
            break;
  ...
  export class UserApprovedOutgoingTransfer extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      ownedTimes?: dependency_4.bitbadges.bitbadgeschain.badges.UintRange[];
      allowedCombinations?: IsUserOutgoingTransferAllowed[];
      approvalDetails?: OutgoingApprovalDetails[];
    }) {
      super();
      pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3, 4, 16, 5, 6], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
    ...
    get ownedTimes() {
      return pb_1.Message.getRepeatedWrapperField(this, dependency_4.bitbadges.bitbadgeschain.badges.UintRange, 16) as dependency_4.bitbadges.bitbadgeschain.badges.UintRange[];
    }
    set ownedTimes(value: dependency_4.bitbadges.bitbadgeschain.badges.UintRange[]) {
    ...
    static fromObject(data: {
      ...
      ownedTimes?: ReturnType<typeof dependency_4.bitbadges.bitbadgeschain.badges.UintRange.prototype.toObject>[];
      ...
      if (data.ownedTimes != null) {
        message.ownedTimes = data.ownedTimes.map(item => dependency_4.bitbadges.bitbadgeschain.badges.UintRange.fromObject(item));
      }
    ...
    toObject() {
      ...
      if (this.ownedTimes != null) {
        data.ownedTimes = this.ownedTimes.map((item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.toObject());
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.ownedTimes.length)
        writer.writeRepeatedMessage(16, this.ownedTimes, (item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            ...
            break;
          case 16:
            reader.readMessage(message.ownedTimes, () => pb_1.Message.addToRepeatedWrapperField(message, 16, dependency_4.bitbadges.bitbadgeschain.badges.UintRange.deserialize(reader), dependency_4.bitbadges.bitbadgeschain.badges.UintRange));
            break;
          case 5:
  ...
  export class UserApprovedIncomingTransfer extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      super();
      pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3, 4, 16, 5, 11], this.#one_of_decls);
      if (!Array.isArray(data) && typeof data == "object") {
    ...
    get allowedCombinations() {
      return pb_1.Message.getRepeatedWrapperField(this, IsUserIncomingTransferAllowed, 5) as IsUserIncomingTransferAllowed[];
    }
    set allowedCombinations(value: IsUserIncomingTransferAllowed[]) {
      pb_1.Message.setRepeatedWrapperField(this, 5, value);
    }
    get approvalDetails() {
      return pb_1.Message.getRepeatedWrapperField(this, IncomingApprovalDetails, 11) as IncomingApprovalDetails[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.ownedTimes.length)
        writer.writeRepeatedMessage(16, this.ownedTimes, (item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      if (this.allowedCombinations.length)
        writer.writeRepeatedMessage(5, this.allowedCombinations, (item: IsUserIncomingTransferAllowed) => item.serialize(writer));
      if (this.approvalDetails.length)
        writer.writeRepeatedMessage(11, this.approvalDetails, (item: IncomingApprovalDetails) => item.serialize(writer));
      if (!w)
        return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 16:
            ...
            break;
          case 5:
            reader.readMessage(message.allowedCombinations, () => pb_1.Message.addToRepeatedWrapperField(message, 5, IsUserIncomingTransferAllowed.deserialize(reader), IsUserIncomingTransferAllowed));
            break;
          case 11:
            reader.readMessage(message.approvalDetails, () => pb_1.Message.addToRepeatedWrapperField(message, 11, IncomingApprovalDetails.deserialize(reader), IncomingApprovalDetails));
            break;
          default: reader.skipField();
        }
      }
  ...
  export class IncrementedBalances extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("incrementOwnedTimesBy" in data && data.incrementOwnedTimesBy != undefined) {
          this.incrementOwnedTimesBy = data.incrementOwnedTimesBy;
        }
      }
    }
    get startBalances() {
    ...
    get incrementOwnedTimesBy() {
      return pb_1.Message.getFieldWithDefault(this, 3, "") as string;
    }
    set incrementOwnedTimesBy(value: string) {
      pb_1.Message.setField(this, 3, value);
    }
    static fromObject(data: {
      ...
      if (data.incrementOwnedTimesBy != null) {
        message.incrementOwnedTimesBy = data.incrementOwnedTimesBy;
      }
      return message;
    }
    toObject() {
      ...
      if (this.incrementOwnedTimesBy != null) {
        data.incrementOwnedTimesBy = this.incrementOwnedTimesBy;
      }
      return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.incrementOwnedTimesBy.length)
        writer.writeString(3, this.incrementOwnedTimesBy);
      if (!w)
        return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            ...
            break;
          case 3:
            message.incrementOwnedTimesBy = reader.readString();
            break;
          default: reader.skipField();
        }
      }
  ...
  export class ApprovalDetails extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.approvalId.length)
        writer.writeString(6, this.approvalId);
      if (this.uri.length)
  ...
  export class CollectionApprovedTransfer extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.ownedTimes.length)
        writer.writeRepeatedMessage(9, this.ownedTimes, (item: dependency_4.bitbadges.bitbadgeschain.badges.UintRange) => item.serialize(writer));
      if (this.allowedCombinations.length)
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 8:
            ...
            break;
          case 9:
            reader.readMessage(message.ownedTimes, () => pb_1.Message.addToRepeatedWrapperField(message, 9, dependency_4.bitbadges.bitbadgeschain.badges.UintRange.deserialize(reader), dependency_4.bitbadges.bitbadgeschain.badges.UintRange));
            break;
          case 10:
  ...
  export class ApprovalIdDetails extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
      approvalId?: string;
    ...
    static fromObject(data: {
      ...
      const message = new ApprovalIdDetails({});
      if (data.approvalId != null) {
        message.approvalId = data.approvalId;
      }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ApprovalIdDetails {
      const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ApprovalIdDetails();
      while (reader.nextField()) {
        if (reader.isEndGroup())
          break;
        switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ApprovalIdDetails {
      return ApprovalIdDetails.deserialize(bytes);
    }
  }
  export class Transfer extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      if (!Array.isArray(data) && typeof data == "object") {
        ...
        if ("precalculateFromApproval" in data && data.precalculateFromApproval != undefined) {
          this.precalculateFromApproval = data.precalculateFromApproval;
        }
    ...
    get precalculateFromApproval() {
      return pb_1.Message.getWrapperField(this, ApprovalIdDetails, 4) as ApprovalIdDetails;
    }
    set precalculateFromApproval(value: ApprovalIdDetails) {
      pb_1.Message.setWrapperField(this, 4, value);
    }
    get has_precalculateFromApproval() {
      return pb_1.Message.getField(this, 4) != null;
    }
    get merkleProofs() {
    ...
    static fromObject(data: {
      ...
      toAddresses?: string[];
      balances?: ReturnType<typeof dependency_4.bitbadges.bitbadgeschain.badges.Balance.prototype.toObject>[];
      precalculateFromApproval?: ReturnType<typeof ApprovalIdDetails.prototype.toObject>;
      ...
      if (data.precalculateFromApproval != null) {
        message.precalculateFromApproval = ApprovalIdDetails.fromObject(data.precalculateFromApproval);
      }
    ...
    toObject() {
      ...
      if (this.precalculateFromApproval != null) {
        data.precalculateFromApproval = this.precalculateFromApproval.toObject();
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_precalculateFromApproval)
        writer.writeMessage(4, this.precalculateFromApproval, () => this.precalculateFromApproval.serialize(writer));
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 3:
            ...
            break;
          case 4:
            reader.readMessage(message.precalculateFromApproval, () => message.precalculateFromApproval = ApprovalIdDetails.deserialize(reader));
            break;
          case 5:
