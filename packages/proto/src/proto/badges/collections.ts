...
export namespace bitbadges.bitbadgeschain.badges {
  export class BadgeCollection extends pb_1.Message {
    ...
    constructor(data?: any[] | {
      ...
      inheritedBalancesTimeline?: dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline[];
      ...
      super();
      pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 14, 15], this.#one_of_decls);
    ...
    get inheritedBalancesTimeline() {
      return pb_1.Message.getRepeatedWrapperField(this, dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline, 6) as dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline[];
    }
    set inheritedBalancesTimeline(value: dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline[]) {
    ...
    static fromObject(data: {
      ...
      inheritedBalancesTimeline?: ReturnType<typeof dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline.prototype.toObject>[];
      ...
      if (data.inheritedBalancesTimeline != null) {
        message.inheritedBalancesTimeline = data.inheritedBalancesTimeline.map(item => dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline.fromObject(item));
      }
    ...
    toObject() {
      ...
      if (this.inheritedBalancesTimeline != null) {
        data.inheritedBalancesTimeline = this.inheritedBalancesTimeline.map((item: dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline) => item.toObject());
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.inheritedBalancesTimeline.length)
        writer.writeRepeatedMessage(6, this.inheritedBalancesTimeline, (item: dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline) => item.serialize(writer));
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 5:
            ...
            break;
          case 6:
            reader.readMessage(message.inheritedBalancesTimeline, () => pb_1.Message.addToRepeatedWrapperField(message, 6, dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline.deserialize(reader), dependency_6.bitbadges.bitbadgeschain.badges.InheritedBalancesTimeline));
            break;
          case 7:
