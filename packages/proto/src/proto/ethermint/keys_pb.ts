...
// @generated from file ethermint/keys.proto (package ethermint, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message ethermint.PubKey
 */
export class PubKey extends Message<PubKey> {
  ...
  static readonly typeName = "ethermint.PubKey";
 ...
 *
 * @generated from message ethermint.PrivKey
 */
export class PrivKey extends Message<PrivKey> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ethermint.PrivKey";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "key", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
