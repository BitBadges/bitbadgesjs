...
export function createEIP712MsgDelegate(
...
export function createEIP712MsgBeginRedelegate(
  delegatorAddress: string,
...
export function createEIP712MsgUndelegate(
  delegatorAddress: string,
  validatorAddress: string,
  amount: string,
  denom: string,
...
export function createEIP712MsgWithdrawDelegatorReward(
  delegatorAddress: string,
  validatorAddress: string,
) {
  return {
...
export function createEIP712MsgWithdrawValidatorCommission(validatorAddress: string) {
  return {
