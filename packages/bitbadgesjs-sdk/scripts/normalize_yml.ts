...
fs.readFile(filePath, 'utf8', (err, data) => {
  ...
  try {
    ...
    const postToGetRoutes = [
      { route: '/users', schema: 'iGetAccountsPayload' },
      { route: '/status', schema: '' },
      ...
      { route: '/addressLists/fetch', schema: 'iGetAddressListsPayload' },
      { route: '/siwbb/token', schema: 'iExchangeSIWBBAuthorizationCodePayload' },
