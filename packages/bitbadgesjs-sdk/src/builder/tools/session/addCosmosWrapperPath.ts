...
export const addCosmosWrapperPathSchema = z.object({
  ...
  pathImage: z.string().optional().describe('Image value for this wrapper path (off-chain metadata). Accepts IMAGE_N, https://, ipfs://, or data:image/svg+xml;base64,... URI. Reusing the collection image here is fine; leave it empty to let get_transaction fill it.'),
