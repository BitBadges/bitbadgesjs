...
| standards | string[] | @pattern "Fungible Tokens", "NFTs", "Smart Token", "Liquidity Pools", "NFTMarketplace", "NFTPricingDenom:DENOM", "Non-Transferable", "AI Agent Stablecoin", "AI Agent Vault". Legacy aliases: "Tradable" (use "NFTMarketplace"), "DefaultDisplayCurrency:DENOM" (use "NFTPricingDenom:DENOM") |
