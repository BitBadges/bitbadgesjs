...
export class MsgSetIncomingApproval<T extends NumberType> extends CustomTypeClass<MsgSetIncomingApproval<T>> implements iMsgSetIncomingApproval<T> {
  ...
  toProto(): prototokenization.MsgSetIncomingApproval {
    return new prototokenization.MsgSetIncomingApproval({
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgSetIncomingApproval.fromProto(prototokenization.MsgSetIncomingApproval.fromJson(jsonValue, options), convertFunction);
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgSetIncomingApproval.fromProto(prototokenization.MsgSetIncomingApproval.fromJsonString(jsonString, options), convertFunction);
  }

  static fromProto<U extends NumberType>(
    protoMsg: prototokenization.MsgSetIncomingApproval,
    convertFunction: (item: NumberType) => U
  ): MsgSetIncomingApproval<U> {
