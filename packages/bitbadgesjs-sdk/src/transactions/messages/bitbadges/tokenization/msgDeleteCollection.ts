...
export class MsgDeleteCollection<T extends NumberType> extends BaseNumberTypeClass<MsgDeleteCollection<T>> implements iMsgDeleteCollection<T> {
  ...
  toProto(): prototokenization.MsgDeleteCollection {
    return new prototokenization.MsgDeleteCollection(this.convert(Stringify));
  }
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgDeleteCollection.fromProto(prototokenization.MsgDeleteCollection.fromJson(jsonValue, options));
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgDeleteCollection.fromProto(prototokenization.MsgDeleteCollection.fromJsonString(jsonString, options));
  }

  static fromProto<U extends NumberType>(protoMsg: prototokenization.MsgDeleteCollection): MsgDeleteCollection<U> {
