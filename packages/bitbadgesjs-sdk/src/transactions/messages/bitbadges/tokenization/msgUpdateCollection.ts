...
export class MsgUpdateCollection<T extends NumberType> extends BaseNumberTypeClass<MsgUpdateCollection<T>> implements iMsgUpdateCollection<T> {
  ...
  toProto(): prototokenization.MsgUpdateCollection {
    return new prototokenization.MsgUpdateCollection(this.convert(Stringify));
  }
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgUpdateCollection.fromProto(prototokenization.MsgUpdateCollection.fromJson(jsonValue, options), convertFunction);
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgUpdateCollection.fromProto(prototokenization.MsgUpdateCollection.fromJsonString(jsonString, options), convertFunction);
  }

  static fromProto<U extends NumberType>(
    protoMsg: prototokenization.MsgUpdateCollection,
    convertFunction: (item: NumberType) => U
  ): MsgUpdateCollection<U> {
