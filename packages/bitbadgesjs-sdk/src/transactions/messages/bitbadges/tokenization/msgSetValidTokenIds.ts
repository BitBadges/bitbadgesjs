...
export class MsgSetValidTokenIds<T extends NumberType> extends CustomTypeClass<MsgSetValidTokenIds<T>> implements iMsgSetValidTokenIds<T> {
  ...
  toProto(): prototokenization.MsgSetValidTokenIds {
    return new prototokenization.MsgSetValidTokenIds({
  ...
  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgSetValidTokenIds<NumberType> {
    return MsgSetValidTokenIds.fromProto(prototokenization.MsgSetValidTokenIds.fromJson(jsonValue, options));
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgSetValidTokenIds<NumberType> {
    return MsgSetValidTokenIds.fromProto(prototokenization.MsgSetValidTokenIds.fromJsonString(jsonString, options));
  }

  static fromProto(protoMsg: prototokenization.MsgSetValidTokenIds): MsgSetValidTokenIds<NumberType> {
