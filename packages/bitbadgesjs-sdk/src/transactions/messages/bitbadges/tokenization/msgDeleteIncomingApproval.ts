...
export class MsgDeleteIncomingApproval extends CustomTypeClass<MsgDeleteIncomingApproval> implements iMsgDeleteIncomingApproval {
  ...
  toProto(): prototokenization.MsgDeleteIncomingApproval {
    return new prototokenization.MsgDeleteIncomingApproval({
  ...
  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgDeleteIncomingApproval {
    return MsgDeleteIncomingApproval.fromProto(prototokenization.MsgDeleteIncomingApproval.fromJson(jsonValue, options));
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgDeleteIncomingApproval {
    return MsgDeleteIncomingApproval.fromProto(prototokenization.MsgDeleteIncomingApproval.fromJsonString(jsonString, options));
  }

  static fromProto(protoMsg: prototokenization.MsgDeleteIncomingApproval): MsgDeleteIncomingApproval {
