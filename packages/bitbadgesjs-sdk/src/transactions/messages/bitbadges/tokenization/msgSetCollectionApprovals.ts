  ...
  implements iMsgSetCollectionApprovals<T>
{
  ...
  toProto(): prototokenization.MsgSetCollectionApprovals {
    return new prototokenization.MsgSetCollectionApprovals({
  ...
  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgSetCollectionApprovals<NumberType> {
    return MsgSetCollectionApprovals.fromProto(prototokenization.MsgSetCollectionApprovals.fromJson(jsonValue, options));
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgSetCollectionApprovals<NumberType> {
    return MsgSetCollectionApprovals.fromProto(prototokenization.MsgSetCollectionApprovals.fromJsonString(jsonString, options));
  }

  static fromProto(protoMsg: prototokenization.MsgSetCollectionApprovals): MsgSetCollectionApprovals<NumberType> {
