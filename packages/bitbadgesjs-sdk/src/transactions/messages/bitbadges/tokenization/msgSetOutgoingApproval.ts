...
export class MsgSetOutgoingApproval<T extends NumberType> extends CustomTypeClass<MsgSetOutgoingApproval<T>> implements iMsgSetOutgoingApproval<T> {
  ...
  toProto(): prototokenization.MsgSetOutgoingApproval {
    return new prototokenization.MsgSetOutgoingApproval({
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgSetOutgoingApproval.fromProto(prototokenization.MsgSetOutgoingApproval.fromJson(jsonValue, options), convertFunction);
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgSetOutgoingApproval.fromProto(prototokenization.MsgSetOutgoingApproval.fromJsonString(jsonString, options), convertFunction);
  }

  static fromProto<U extends NumberType>(
    protoMsg: prototokenization.MsgSetOutgoingApproval,
    convertFunction: (item: NumberType) => U
  ): MsgSetOutgoingApproval<U> {
