...
export class MsgTransferTokens<T extends NumberType> extends BaseNumberTypeClass<MsgTransferTokens<T>> implements iMsgTransferTokens<T> {
  ...
  toProto(): prototokenization.MsgTransferTokens {
    return new prototokenization.MsgTransferTokens(this.convert(Stringify));
  }
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgTransferTokens.fromProto(prototokenization.MsgTransferTokens.fromJson(jsonValue, options), convertFunction);
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgTransferTokens.fromProto(prototokenization.MsgTransferTokens.fromJsonString(jsonString, options), convertFunction);
  }

  static fromProto<U extends NumberType>(protoMsg: prototokenization.MsgTransferTokens, convertFunction: (item: NumberType) => U): MsgTransferTokens<U> {
