  ...
  implements iMsgUpdateUserApprovals<T>
{
  ...
  toProto(): prototokenization.MsgUpdateUserApprovals {
    return new prototokenization.MsgUpdateUserApprovals(this.convert(Stringify));
  }
  ...
  static fromJson<U extends NumberType>(
    ...
    return MsgUpdateUserApprovals.fromProto(prototokenization.MsgUpdateUserApprovals.fromJson(jsonValue, options), convertFunction);
  }
  ...
  static fromJsonString<U extends NumberType>(
    ...
    return MsgUpdateUserApprovals.fromProto(prototokenization.MsgUpdateUserApprovals.fromJsonString(jsonString, options), convertFunction);
  }

  static fromProto<U extends NumberType>(
    protoMsg: prototokenization.MsgUpdateUserApprovals,
    convertFunction: (item: NumberType) => U
  ): MsgUpdateUserApprovals<U> {
