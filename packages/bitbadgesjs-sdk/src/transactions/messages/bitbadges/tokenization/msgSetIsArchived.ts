...
export class MsgSetIsArchived<T extends NumberType> extends CustomTypeClass<MsgSetIsArchived<T>> implements iMsgSetIsArchived<T> {
  ...
  toProto(): prototokenization.MsgSetIsArchived {
    return new prototokenization.MsgSetIsArchived({
  ...
  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgSetIsArchived<NumberType> {
    return MsgSetIsArchived.fromProto(prototokenization.MsgSetIsArchived.fromJson(jsonValue, options));
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgSetIsArchived<NumberType> {
    return MsgSetIsArchived.fromProto(prototokenization.MsgSetIsArchived.fromJsonString(jsonString, options));
  }

  static fromProto(protoMsg: prototokenization.MsgSetIsArchived): MsgSetIsArchived<NumberType> {
