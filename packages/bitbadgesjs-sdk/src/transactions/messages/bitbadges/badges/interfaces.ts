...
import type { CollectionId, iAddressList, iApprovalIdentifierDetails, iCollectionMetadata, iAliasPathAddObject, iCosmosCoinWrapperPathAddObject, iInvariantsAddObject, iTokenMetadata, iTransfer, iUintRange } from '../../../../interfaces/types/core.js';
import type { iActionPermission, iCollectionApprovalPermission, iCollectionPermissions, iTokenIdsActionPermission, iUserPermissions } from '../../../../interfaces/types/permissions.js';
...
export interface iMsgCreateCollection {
  ...
  mintEscrowCoinsToTransfer?: iCosmosCoin[];

  /** The IBC wrapper paths to add. */
  cosmosCoinWrapperPathsToAdd?: iCosmosCoinWrapperPathAddObject[];

  /** The alias (non-wrapping) paths to add. */
  aliasPathsToAdd?: iAliasPathAddObject[];
  ...
  invariants?: iInvariantsAddObject;
}
 ...
 * @category Interfaces
 */
export interface iMsgTransferTokens {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
 ...
 * @category Interfaces
 */
export interface iMsgUpdateCollection extends Omit<iMsgUniversalUpdateCollection, 'defaultBalances'> {}
 ...
 * @category Interfaces
 */
export interface iMsgUpdateDynamicStore {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
 ...
 * @category Interfaces
 */
export interface iMsgDeleteDynamicStore {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
 ...
 * @category Interfaces
 */
export interface iMsgSetDynamicStoreValue {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
 ...
 * @category Interfaces
 */
export interface iMsgSetIncomingApproval {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: CollectionId;
  /** The incoming approval to set. */
  approval: iUserIncomingApproval;
}
 ...
 * @category Interfaces
 */
export interface iMsgSetOutgoingApproval {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: CollectionId;
  /** The outgoing approval to set. */
  approval: iUserOutgoingApproval;
}
 ...
 * @category Interfaces
 */
export interface iMsgPurgeApprovals {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: CollectionId;
  ...
  approvalsToPurge: iApprovalIdentifierDetails[];
}

/**
 * @category Interfaces
 */
export interface iMsgSetValidTokenIds {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
 ...
 * @category Interfaces
 */
export interface iMsgSetManager {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetCollectionMetadata {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetTokenMetadata {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetCustomData {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetStandards {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetCollectionApprovals {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
 ...
 * @category Interfaces
 */
export interface iMsgSetIsArchived {
  /** The creator of the transaction. */
  creator: BitBadgesAddress;
  /** The ID of the collection. */
  collectionId: string | number;
