...
// @generated from file poolmanager/v2/query.proto (package poolmanager.v2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * query.
 *
 * @generated from message poolmanager.v2.SpotPriceRequest
 */
export class SpotPriceRequest extends Message<SpotPriceRequest> {
  ...
  static readonly typeName = "poolmanager.v2.SpotPriceRequest";
 ...
 * query.
 *
 * @generated from message poolmanager.v2.SpotPriceResponse
 */
export class SpotPriceResponse extends Message<SpotPriceResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "poolmanager.v2.SpotPriceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
