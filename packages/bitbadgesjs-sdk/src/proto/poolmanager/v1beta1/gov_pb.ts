...
// @generated from file poolmanager/v1beta1/gov.proto (package poolmanager.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message poolmanager.v1beta1.DenomPairTakerFeeProposal
 */
export class DenomPairTakerFeeProposal extends Message<DenomPairTakerFeeProposal> {
  ...
  /**
   * @generated from field: repeated poolmanager.v1beta1.DenomPairTakerFee denom_pair_taker_fee = 3;
   */
  ...
  static readonly typeName = "poolmanager.v1beta1.DenomPairTakerFeeProposal";
