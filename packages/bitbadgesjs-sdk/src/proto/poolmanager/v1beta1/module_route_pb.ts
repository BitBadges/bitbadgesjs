...
// @generated from file poolmanager/v1beta1/module_route.proto (package poolmanager.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum poolmanager.v1beta1.PoolType
 */
 ...
 * pool id.
 *
 * @generated from message poolmanager.v1beta1.ModuleRoute
 */
export class ModuleRoute extends Message<ModuleRoute> {
  /**
   * pool_type specifies the type of the pool
   *
   * @generated from field: poolmanager.v1beta1.PoolType pool_type = 1;
   */
  ...
  static readonly typeName = "poolmanager.v1beta1.ModuleRoute";
