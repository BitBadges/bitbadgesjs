...
// @generated from file poolmanager/v1beta1/swap_route.proto (package poolmanager.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message poolmanager.v1beta1.SwapAmountInRoute
 */
export class SwapAmountInRoute extends Message<SwapAmountInRoute> {
  ...
  static readonly typeName = "poolmanager.v1beta1.SwapAmountInRoute";
...
/**
 * @generated from message poolmanager.v1beta1.SwapAmountOutRoute
 */
export class SwapAmountOutRoute extends Message<SwapAmountOutRoute> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "poolmanager.v1beta1.SwapAmountOutRoute";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pool_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
/**
 * @generated from message poolmanager.v1beta1.SwapAmountInSplitRoute
 */
export class SwapAmountInSplitRoute extends Message<SwapAmountInSplitRoute> {
  /**
   * @generated from field: repeated poolmanager.v1beta1.SwapAmountInRoute pools = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "poolmanager.v1beta1.SwapAmountInSplitRoute";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message poolmanager.v1beta1.SwapAmountOutSplitRoute
 */
export class SwapAmountOutSplitRoute extends Message<SwapAmountOutSplitRoute> {
  /**
   * @generated from field: repeated poolmanager.v1beta1.SwapAmountOutRoute pools = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "poolmanager.v1beta1.SwapAmountOutSplitRoute";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
