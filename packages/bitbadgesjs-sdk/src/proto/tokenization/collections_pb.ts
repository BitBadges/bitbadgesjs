 ...
 *
 * @generated from message tokenization.CollectionStats
 */
export class CollectionStats extends Message<CollectionStats> {
  /**
   * @generated from field: string holderCount = 1;
   */
  holderCount = "";
   ...
   *
   * @generated from field: repeated tokenization.Balance balances = 2;
   */
  balances: Balance[] = [];

  constructor(data?: PartialMessage<CollectionStats>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.CollectionStats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "holderCount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "balances", kind: "message", T: Balance, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CollectionStats {
    return new CollectionStats().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CollectionStats {
    return new CollectionStats().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CollectionStats {
    return new CollectionStats().fromJsonString(jsonString, options);
  }

  static equals(a: CollectionStats | PlainMessage<CollectionStats> | undefined, b: CollectionStats | PlainMessage<CollectionStats> | undefined): boolean {
    return proto3.util.equals(CollectionStats, a, b);
  }
}
