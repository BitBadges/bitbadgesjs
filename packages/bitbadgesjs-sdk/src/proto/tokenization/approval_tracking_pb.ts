...
// @generated from file tokenization/approval_tracking.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message tokenization.AutoDeletionOptions
 */
export class AutoDeletionOptions extends Message<AutoDeletionOptions> {
  ...
  static readonly typeName = "tokenization.AutoDeletionOptions";
 ...
 *
 * @generated from message tokenization.ResetTimeIntervals
 */
export class ResetTimeIntervals extends Message<ResetTimeIntervals> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ResetTimeIntervals";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.ApprovalAmounts
 */
export class ApprovalAmounts extends Message<ApprovalAmounts> {
   ...
   * Time intervals to reset the trackers at.
   *
   * @generated from field: tokenization.ResetTimeIntervals resetTimeIntervals = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ApprovalAmounts";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * must not exceed the corresponding value.
 *
 * @generated from message tokenization.MaxNumTransfers
 */
export class MaxNumTransfers extends Message<MaxNumTransfers> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MaxNumTransfers";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.ApprovalTracker
 */
export class ApprovalTracker extends Message<ApprovalTracker> {
   ...
   *
   * @generated from field: repeated tokenization.Balance amounts = 2;
   */
  amounts: Balance[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ApprovalTracker";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
