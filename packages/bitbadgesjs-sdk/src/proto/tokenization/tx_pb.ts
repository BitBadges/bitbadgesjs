...
// @generated from file tokenization/tx.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
import { EVMQueryChallenge } from "./challenges_pb.js";
 ...
 *
 * @generated from message tokenization.TokenizationCustomMsgType
 */
export class TokenizationCustomMsgType extends Message<TokenizationCustomMsgType> {
  /**
   * @generated from field: tokenization.MsgCreateAddressLists createAddressListsMsg = 1;
   */
  createAddressListsMsg?: MsgCreateAddressLists;

  /**
   * @generated from field: tokenization.MsgUniversalUpdateCollection universalUpdateCollectionMsg = 2;
   */
  universalUpdateCollectionMsg?: MsgUniversalUpdateCollection;

  /**
   * @generated from field: tokenization.MsgDeleteCollection deleteCollectionMsg = 3;
   */
  deleteCollectionMsg?: MsgDeleteCollection;

  /**
   * @generated from field: tokenization.MsgTransferTokens transferTokensMsg = 4;
   */
  transferTokensMsg?: MsgTransferTokens;

  /**
   * @generated from field: tokenization.MsgUpdateUserApprovals updateUserApprovalsMsg = 5;
   */
  updateUserApprovalsMsg?: MsgUpdateUserApprovals;

  /**
   * @generated from field: tokenization.MsgUpdateCollection updateCollectionMsg = 6;
   */
  updateCollectionMsg?: MsgUpdateCollection;

  /**
   * @generated from field: tokenization.MsgCreateCollection createCollectionMsg = 7;
   */
  createCollectionMsg?: MsgCreateCollection;

  /**
   * @generated from field: tokenization.MsgCreateDynamicStore createDynamicStoreMsg = 8;
   */
  createDynamicStoreMsg?: MsgCreateDynamicStore;

  /**
   * @generated from field: tokenization.MsgUpdateDynamicStore updateDynamicStoreMsg = 9;
   */
  updateDynamicStoreMsg?: MsgUpdateDynamicStore;

  /**
   * @generated from field: tokenization.MsgDeleteDynamicStore deleteDynamicStoreMsg = 10;
   */
  deleteDynamicStoreMsg?: MsgDeleteDynamicStore;

  /**
   * @generated from field: tokenization.MsgSetDynamicStoreValue setDynamicStoreValueMsg = 11;
   */
  setDynamicStoreValueMsg?: MsgSetDynamicStoreValue;

  /**
   * @generated from field: tokenization.MsgSetIncomingApproval setIncomingApprovalMsg = 14;
   */
  setIncomingApprovalMsg?: MsgSetIncomingApproval;

  /**
   * @generated from field: tokenization.MsgDeleteIncomingApproval deleteIncomingApprovalMsg = 15;
   */
  deleteIncomingApprovalMsg?: MsgDeleteIncomingApproval;

  /**
   * @generated from field: tokenization.MsgSetOutgoingApproval setOutgoingApprovalMsg = 16;
   */
  setOutgoingApprovalMsg?: MsgSetOutgoingApproval;

  /**
   * @generated from field: tokenization.MsgDeleteOutgoingApproval deleteOutgoingApprovalMsg = 17;
   */
  deleteOutgoingApprovalMsg?: MsgDeleteOutgoingApproval;

  /**
   * @generated from field: tokenization.MsgPurgeApprovals purgeApprovalsMsg = 18;
   */
   ...
   *
   * @generated from field: tokenization.MsgSetValidTokenIds setValidTokenIdsMsg = 19;
   */
  setValidTokenIdsMsg?: MsgSetValidTokenIds;

  /**
   * @generated from field: tokenization.MsgSetManager setManagerMsg = 20;
   */
  setManagerMsg?: MsgSetManager;

  /**
   * @generated from field: tokenization.MsgSetCollectionMetadata setCollectionMetadataMsg = 21;
   */
  setCollectionMetadataMsg?: MsgSetCollectionMetadata;

  /**
   * @generated from field: tokenization.MsgSetTokenMetadata setTokenMetadataMsg = 22;
   */
  setTokenMetadataMsg?: MsgSetTokenMetadata;

  /**
   * @generated from field: tokenization.MsgSetCustomData setCustomDataMsg = 23;
   */
  setCustomDataMsg?: MsgSetCustomData;

  /**
   * @generated from field: tokenization.MsgSetStandards setStandardsMsg = 24;
   */
  setStandardsMsg?: MsgSetStandards;

  /**
   * @generated from field: tokenization.MsgSetCollectionApprovals setCollectionApprovalsMsg = 25;
   */
  setCollectionApprovalsMsg?: MsgSetCollectionApprovals;

  /**
   * @generated from field: tokenization.MsgSetIsArchived setIsArchivedMsg = 26;
   */
  setIsArchivedMsg?: MsgSetIsArchived;

  /**
   * @generated from field: tokenization.MsgSetReservedProtocolAddress setReservedProtocolAddressMsg = 27;
   */
  setReservedProtocolAddressMsg?: MsgSetReservedProtocolAddress;

  /**
   * @generated from field: tokenization.MsgCastVote castVoteMsg = 28;
   */
  castVoteMsg?: MsgCastVote;

  constructor(data?: PartialMessage<TokenizationCustomMsgType>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.TokenizationCustomMsgType";
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TokenizationCustomMsgType {
    return new TokenizationCustomMsgType().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TokenizationCustomMsgType {
    return new TokenizationCustomMsgType().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TokenizationCustomMsgType {
    return new TokenizationCustomMsgType().fromJsonString(jsonString, options);
  }

  static equals(a: TokenizationCustomMsgType | PlainMessage<TokenizationCustomMsgType> | undefined, b: TokenizationCustomMsgType | PlainMessage<TokenizationCustomMsgType> | undefined): boolean {
    return proto3.util.equals(TokenizationCustomMsgType, a, b);
  }
}
 ...
 *
 * @generated from message tokenization.MsgUpdateParams
 */
export class MsgUpdateParams extends Message<MsgUpdateParams> {
   ...
   *
   * @generated from field: tokenization.Params params = 2;
   */
  params?: Params;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MsgUpdateParamsResponse
 */
export class MsgUpdateParamsResponse extends Message<MsgUpdateParamsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateParamsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message tokenization.CosmosCoinWrapperPathAddObject
 */
export class CosmosCoinWrapperPathAddObject extends Message<CosmosCoinWrapperPathAddObject> {
   ...
   *
   * @generated from field: tokenization.PathMetadata metadata = 6;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.CosmosCoinWrapperPathAddObject";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tokenization.AliasPathAddObject
 */
export class AliasPathAddObject extends Message<AliasPathAddObject> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.AliasPathAddObject";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "denom", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "conversion", kind: "message", T: ConversionWithoutDenom },
    { no: 3, name: "symbol", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tokenization.CosmosCoinBackedPathAddObject
 */
export class CosmosCoinBackedPathAddObject extends Message<CosmosCoinBackedPathAddObject> {
  /**
   * @generated from field: tokenization.Conversion conversion = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.CosmosCoinBackedPathAddObject";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.InvariantsAddObject
 */
export class InvariantsAddObject extends Message<InvariantsAddObject> {
   ...
   *
   * @generated from field: tokenization.CosmosCoinBackedPathAddObject cosmosCoinBackedPath = 3;
   */
   ...
   *
   * @generated from field: repeated tokenization.EVMQueryChallenge evmQueryChallenges = 6;
   */
  evmQueryChallenges: EVMQueryChallenge[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.InvariantsAddObject";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "evmQueryChallenges", kind: "message", T: EVMQueryChallenge, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgUniversalUpdateCollection
 */
export class MsgUniversalUpdateCollection extends Message<MsgUniversalUpdateCollection> {
   ...
   *
   * @generated from field: tokenization.UserBalanceStore defaultBalances = 3;
   */
   ...
   *
   * @generated from field: repeated tokenization.UintRange validTokenIds = 5;
   */
   ...
   *
   * @generated from field: tokenization.CollectionPermissions collectionPermissions = 7;
   */
   ...
   *
   * @generated from field: tokenization.CollectionMetadata collectionMetadata = 11;
   */
   ...
   *
   * @generated from field: repeated tokenization.TokenMetadata tokenMetadata = 13;
   */
   ...
   *
   * @generated from field: repeated tokenization.CollectionApproval collectionApprovals = 17;
   */
   ...
   *
   * @generated from field: repeated tokenization.CosmosCoinWrapperPathAddObject cosmosCoinWrapperPathsToAdd = 23;
   */
   ...
   * Addresses are generated by the keeper and stored in the collection.
   *
   * @generated from field: tokenization.InvariantsAddObject invariants = 24;
   */
   ...
   *
   * @generated from field: repeated tokenization.AliasPathAddObject aliasPathsToAdd = 25;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUniversalUpdateCollection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MsgUniversalUpdateCollectionResponse
 */
export class MsgUniversalUpdateCollectionResponse extends Message<MsgUniversalUpdateCollectionResponse> {
  ...
  /**
   * @generated from field: repeated tokenization.ApprovalChange approvalChanges = 2;
   */
  approvalChanges: ApprovalChange[] = [];

  /**
   * @generated from field: repeated string reviewItems = 3;
   */
  reviewItems: string[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUniversalUpdateCollectionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "approvalChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgUpdateCollection
 */
export class MsgUpdateCollection extends Message<MsgUpdateCollection> {
   ...
   * New token IDs to add to this collection
   *
   * @generated from field: repeated tokenization.UintRange validTokenIds = 4;
   */
  validTokenIds: UintRange[] = [];
   ...
   * New collection metadata to set.
   *
   * @generated from field: tokenization.CollectionMetadata collectionMetadata = 10;
   */
  collectionMetadata?: CollectionMetadata;
   ...
   * New token metadata to set.
   *
   * @generated from field: repeated tokenization.TokenMetadata tokenMetadata = 12;
   */
  tokenMetadata: TokenMetadata[] = [];
   ...
   * New collection approvals to set.
   *
   * @generated from field: repeated tokenization.CollectionApproval collectionApprovals = 16;
   */
  collectionApprovals: CollectionApproval[] = [];
   ...
   * IBC wrapper paths to add.
   *
   * @generated from field: repeated tokenization.CosmosCoinWrapperPathAddObject cosmosCoinWrapperPathsToAdd = 22;
   */
  cosmosCoinWrapperPathsToAdd: CosmosCoinWrapperPathAddObject[] = [];
   ...
   * Addresses are generated by the keeper and stored in the collection.
   *
   * @generated from field: tokenization.InvariantsAddObject invariants = 23;
   */
  invariants?: InvariantsAddObject;
   ...
   * Alias (non-wrapping) paths to add.
   *
   * @generated from field: repeated tokenization.AliasPathAddObject aliasPathsToAdd = 24;
   */
  aliasPathsToAdd: AliasPathAddObject[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateCollection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgUpdateCollectionResponse
 */
export class MsgUpdateCollectionResponse extends Message<MsgUpdateCollectionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateCollectionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "approvalChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgCreateCollection
 */
export class MsgCreateCollection extends Message<MsgCreateCollection> {
   ...
   * The default balances for the user
   *
   * @generated from field: tokenization.UserBalanceStore defaultBalances = 2;
   */
  defaultBalances?: UserBalanceStore;
   ...
   * New token IDs to add to this collection
   *
   * @generated from field: repeated tokenization.UintRange validTokenIds = 3;
   */
  validTokenIds: UintRange[] = [];
   ...
   *
   * @generated from field: tokenization.CollectionPermissions collectionPermissions = 4;
   */
  collectionPermissions?: CollectionPermissions;
   ...
   * Collection metadata.
   *
   * @generated from field: tokenization.CollectionMetadata collectionMetadata = 6;
   */
  collectionMetadata?: CollectionMetadata;
   ...
   *
   * @generated from field: repeated tokenization.TokenMetadata tokenMetadata = 7;
   */
  tokenMetadata: TokenMetadata[] = [];
   ...
   *
   * @generated from field: repeated tokenization.CollectionApproval collectionApprovals = 9;
   */
  collectionApprovals: CollectionApproval[] = [];
   ...
   * IBC wrapper paths to add.
   *
   * @generated from field: repeated tokenization.CosmosCoinWrapperPathAddObject cosmosCoinWrapperPathsToAdd = 13;
   */
  cosmosCoinWrapperPathsToAdd: CosmosCoinWrapperPathAddObject[] = [];
   ...
   * Addresses are generated by the keeper and stored in the collection.
   *
   * @generated from field: tokenization.InvariantsAddObject invariants = 14;
   */
  invariants?: InvariantsAddObject;
   ...
   * Alias (non-wrapping) paths to add.
   *
   * @generated from field: repeated tokenization.AliasPathAddObject aliasPathsToAdd = 15;
   */
  aliasPathsToAdd: AliasPathAddObject[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateCollection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgCreateCollectionResponse
 */
export class MsgCreateCollectionResponse extends Message<MsgCreateCollectionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateCollectionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "approvalChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgCreateAddressLists
 */
export class MsgCreateAddressLists extends Message<MsgCreateAddressLists> {
   ...
   *
   * @generated from field: repeated tokenization.AddressListInput addressLists = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateAddressLists";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgCreateAddressListsResponse
 */
export class MsgCreateAddressListsResponse extends Message<MsgCreateAddressListsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateAddressListsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.MsgTransferTokens
 */
export class MsgTransferTokens extends Message<MsgTransferTokens> {
   ...
   *
   * @generated from field: repeated tokenization.Transfer transfers = 3;
   */
  transfers: Transfer[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgTransferTokens";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgTransferTokensResponse
 */
export class MsgTransferTokensResponse extends Message<MsgTransferTokensResponse> {
  /**
   * @generated from field: repeated tokenization.ApprovalUsed approvalsUsed = 1;
   */
  approvalsUsed: ApprovalUsed[] = [];

  /**
   * @generated from field: repeated tokenization.CoinTransferProto coinTransfers = 2;
   */
  coinTransfers: CoinTransferProto[] = [];

  /**
   * @generated from field: repeated tokenization.Balance balancesTransferred = 3;
   */
  balancesTransferred: Balance[] = [];

  /**
   * @generated from field: repeated string reviewItems = 4;
   */
  reviewItems: string[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgTransferTokensResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "approvalsUsed", kind: "message", T: ApprovalUsed, repeated: true },
    { no: 2, name: "coinTransfers", kind: "message", T: CoinTransferProto, repeated: true },
    { no: 3, name: "balancesTransferred", kind: "message", T: Balance, repeated: true },
    { no: 4, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgDeleteCollection
 */
export class MsgDeleteCollection extends Message<MsgDeleteCollection> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteCollection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgDeleteCollectionResponse
 */
export class MsgDeleteCollectionResponse extends Message<MsgDeleteCollectionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteCollectionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.MsgUpdateUserApprovals
 */
export class MsgUpdateUserApprovals extends Message<MsgUpdateUserApprovals> {
   ...
   *
   * @generated from field: repeated tokenization.UserOutgoingApproval outgoingApprovals = 4;
   */
   ...
   *
   * @generated from field: repeated tokenization.UserIncomingApproval incomingApprovals = 6;
   */
   ...
   *
   * @generated from field: tokenization.UserPermissions userPermissions = 14;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateUserApprovals";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgUpdateUserApprovalsResponse
 */
export class MsgUpdateUserApprovalsResponse extends Message<MsgUpdateUserApprovalsResponse> {
  /**
   * @generated from field: repeated tokenization.ApprovalChange incomingChanges = 1;
   */
  incomingChanges: ApprovalChange[] = [];

  /**
   * @generated from field: repeated tokenization.ApprovalChange outgoingChanges = 2;
   */
  outgoingChanges: ApprovalChange[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateUserApprovalsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "incomingChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 2, name: "outgoingChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetIncomingApproval
 */
export class MsgSetIncomingApproval extends Message<MsgSetIncomingApproval> {
   ...
   *
   * @generated from field: tokenization.UserIncomingApproval approval = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetIncomingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetIncomingApprovalResponse
 */
export class MsgSetIncomingApprovalResponse extends Message<MsgSetIncomingApprovalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetIncomingApprovalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MsgDeleteIncomingApproval
 */
export class MsgDeleteIncomingApproval extends Message<MsgDeleteIncomingApproval> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteIncomingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgDeleteIncomingApprovalResponse
 */
export class MsgDeleteIncomingApprovalResponse extends Message<MsgDeleteIncomingApprovalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteIncomingApprovalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MsgSetOutgoingApproval
 */
export class MsgSetOutgoingApproval extends Message<MsgSetOutgoingApproval> {
   ...
   *
   * @generated from field: tokenization.UserOutgoingApproval approval = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetOutgoingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetOutgoingApprovalResponse
 */
export class MsgSetOutgoingApprovalResponse extends Message<MsgSetOutgoingApprovalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetOutgoingApprovalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "action", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgDeleteOutgoingApproval
 */
export class MsgDeleteOutgoingApproval extends Message<MsgDeleteOutgoingApproval> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteOutgoingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "approvalId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgDeleteOutgoingApprovalResponse
 */
export class MsgDeleteOutgoingApprovalResponse extends Message<MsgDeleteOutgoingApprovalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteOutgoingApprovalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "found", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgPurgeApprovals
 */
export class MsgPurgeApprovals extends Message<MsgPurgeApprovals> {
   ...
   *
   * @generated from field: repeated tokenization.ApprovalIdentifierDetails approvalsToPurge = 6;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgPurgeApprovals";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgPurgeApprovalsResponse
 */
export class MsgPurgeApprovalsResponse extends Message<MsgPurgeApprovalsResponse> {
  ...
  /**
   * @generated from field: repeated string purgedApprovalIds = 2;
   */
  purgedApprovalIds: string[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgPurgeApprovalsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "numPurged", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "purgedApprovalIds", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgCreateDynamicStore
 */
export class MsgCreateDynamicStore extends Message<MsgCreateDynamicStore> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateDynamicStore";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgCreateDynamicStoreResponse
 */
export class MsgCreateDynamicStoreResponse extends Message<MsgCreateDynamicStoreResponse> {
  ...
  /**
   * @generated from field: repeated string reviewItems = 2;
   */
  reviewItems: string[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCreateDynamicStoreResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "storeId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgUpdateDynamicStore
 */
export class MsgUpdateDynamicStore extends Message<MsgUpdateDynamicStore> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateDynamicStore";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgUpdateDynamicStoreResponse
 */
export class MsgUpdateDynamicStoreResponse extends Message<MsgUpdateDynamicStoreResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgUpdateDynamicStoreResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.MsgDeleteDynamicStore
 */
export class MsgDeleteDynamicStore extends Message<MsgDeleteDynamicStore> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteDynamicStore";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "storeId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgDeleteDynamicStoreResponse
 */
export class MsgDeleteDynamicStoreResponse extends Message<MsgDeleteDynamicStoreResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgDeleteDynamicStoreResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetDynamicStoreValue
 */
export class MsgSetDynamicStoreValue extends Message<MsgSetDynamicStoreValue> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetDynamicStoreValue";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "storeId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetDynamicStoreValueResponse
 */
export class MsgSetDynamicStoreValueResponse extends Message<MsgSetDynamicStoreValueResponse> {
  /**
   * @generated from field: string previousValue = 1;
   */
  previousValue = "";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetDynamicStoreValueResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "previousValue", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetValidTokenIds
 */
export class MsgSetValidTokenIds extends Message<MsgSetValidTokenIds> {
   ...
   *
   * @generated from field: repeated tokenization.TokenIdsActionPermission canUpdateValidTokenIds = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetValidTokenIds";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "validTokenIds", kind: "message", T: UintRange, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgSetValidTokenIdsResponse
 */
export class MsgSetValidTokenIdsResponse extends Message<MsgSetValidTokenIdsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetValidTokenIdsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetManager
 */
export class MsgSetManager extends Message<MsgSetManager> {
   ...
   *
   * @generated from field: repeated tokenization.ActionPermission canUpdateManager = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetManager";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetManagerResponse
 */
export class MsgSetManagerResponse extends Message<MsgSetManagerResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetManagerResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetCollectionMetadata
 */
export class MsgSetCollectionMetadata extends Message<MsgSetCollectionMetadata> {
   ...
   * New collection metadata to set.
   *
   * @generated from field: tokenization.CollectionMetadata collectionMetadata = 3;
   */
  collectionMetadata?: CollectionMetadata;
   ...
   *
   * @generated from field: repeated tokenization.ActionPermission canUpdateCollectionMetadata = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCollectionMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetCollectionMetadataResponse
 */
export class MsgSetCollectionMetadataResponse extends Message<MsgSetCollectionMetadataResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCollectionMetadataResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetTokenMetadata
 */
export class MsgSetTokenMetadata extends Message<MsgSetTokenMetadata> {
   ...
   *
   * @generated from field: repeated tokenization.TokenIdsActionPermission canUpdateTokenMetadata = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetTokenMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetTokenMetadataResponse
 */
export class MsgSetTokenMetadataResponse extends Message<MsgSetTokenMetadataResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetTokenMetadataResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetCustomData
 */
export class MsgSetCustomData extends Message<MsgSetCustomData> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCustomData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetCustomDataResponse
 */
export class MsgSetCustomDataResponse extends Message<MsgSetCustomDataResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCustomDataResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetStandards
 */
export class MsgSetStandards extends Message<MsgSetStandards> {
   ...
   *
   * @generated from field: repeated tokenization.ActionPermission canUpdateStandards = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetStandards";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetStandardsResponse
 */
export class MsgSetStandardsResponse extends Message<MsgSetStandardsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetStandardsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetCollectionApprovals
 */
export class MsgSetCollectionApprovals extends Message<MsgSetCollectionApprovals> {
   ...
   *
   * @generated from field: repeated tokenization.CollectionApprovalPermission canUpdateCollectionApprovals = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCollectionApprovals";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetCollectionApprovalsResponse
 */
export class MsgSetCollectionApprovalsResponse extends Message<MsgSetCollectionApprovalsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetCollectionApprovalsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "approvalChanges", kind: "message", T: ApprovalChange, repeated: true },
    { no: 3, name: "reviewItems", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
 ...
 *
 * @generated from message tokenization.MsgSetIsArchived
 */
export class MsgSetIsArchived extends Message<MsgSetIsArchived> {
   ...
   *
   * @generated from field: repeated tokenization.ActionPermission canArchiveCollection = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetIsArchived";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetIsArchivedResponse
 */
export class MsgSetIsArchivedResponse extends Message<MsgSetIsArchivedResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetIsArchivedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.MsgSetReservedProtocolAddress
 */
export class MsgSetReservedProtocolAddress extends Message<MsgSetReservedProtocolAddress> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetReservedProtocolAddress";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "authority", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tokenization.MsgSetReservedProtocolAddressResponse
 */
export class MsgSetReservedProtocolAddressResponse extends Message<MsgSetReservedProtocolAddressResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgSetReservedProtocolAddressResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.MsgCastVote
 */
export class MsgCastVote extends Message<MsgCastVote> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCastVote";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "collectionId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tokenization.MsgCastVoteResponse
 */
export class MsgCastVoteResponse extends Message<MsgCastVoteResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MsgCastVoteResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message tokenization.ApprovalUsed
 */
export class ApprovalUsed extends Message<ApprovalUsed> {
  /**
  ...
  constructor(data?: PartialMessage<ApprovalUsed>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ApprovalUsed";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ApprovalUsed {
    return new ApprovalUsed().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ApprovalUsed {
    return new ApprovalUsed().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ApprovalUsed {
    return new ApprovalUsed().fromJsonString(jsonString, options);
  }

  static equals(a: ApprovalUsed | PlainMessage<ApprovalUsed> | undefined, b: ApprovalUsed | PlainMessage<ApprovalUsed> | undefined): boolean {
    return proto3.util.equals(ApprovalUsed, a, b);
  }
}
 ...
 *
 * @generated from message tokenization.CoinTransferProto
 */
export class CoinTransferProto extends Message<CoinTransferProto> {
  /**
  ...
  /**
   * @generated from field: bool isProtocolFee = 5;
   */
  isProtocolFee = false;

  constructor(data?: PartialMessage<CoinTransferProto>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.CoinTransferProto";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "from", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "to", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "denom", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "isProtocolFee", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CoinTransferProto {
    return new CoinTransferProto().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CoinTransferProto {
    return new CoinTransferProto().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CoinTransferProto {
    return new CoinTransferProto().fromJsonString(jsonString, options);
  }

  static equals(a: CoinTransferProto | PlainMessage<CoinTransferProto> | undefined, b: CoinTransferProto | PlainMessage<CoinTransferProto> | undefined): boolean {
    return proto3.util.equals(CoinTransferProto, a, b);
  }
}
 ...
 *
 * @generated from message tokenization.ApprovalChange
 */
export class ApprovalChange extends Message<ApprovalChange> {
  /**
   * @generated from field: string approvalId = 1;
   */
  approvalId = "";
  ...
  constructor(data?: PartialMessage<ApprovalChange>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ApprovalChange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "approvalId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "approvalLevel", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ApprovalChange {
    return new ApprovalChange().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ApprovalChange {
    return new ApprovalChange().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ApprovalChange {
    return new ApprovalChange().fromJsonString(jsonString, options);
  }

  static equals(a: ApprovalChange | PlainMessage<ApprovalChange> | undefined, b: ApprovalChange | PlainMessage<ApprovalChange> | undefined): boolean {
    return proto3.util.equals(ApprovalChange, a, b);
  }
}
