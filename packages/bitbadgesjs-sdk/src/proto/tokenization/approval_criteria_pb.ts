...
// @generated from file tokenization/approval_criteria.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { ETHSignatureChallenge, EVMQueryChallenge, MerkleChallenge, VotingChallenge } from "./challenges_pb.js";
...
import { AddressChecks, AltTimeChecks, CoinTransfer, DynamicStoreChallenge, MustOwnTokens, UserApprovalSettings } from "./approval_conditions_pb.js";
 ...
 *
 * @generated from message tokenization.ApprovalCriteria
 */
export class ApprovalCriteria extends Message<ApprovalCriteria> {
   ...
   *
   * @generated from field: repeated tokenization.MerkleChallenge merkleChallenges = 1;
   */
   ...
   *
   * @generated from field: tokenization.PredeterminedBalances predeterminedBalances = 2;
   */
   ...
   *
   * @generated from field: tokenization.ApprovalAmounts approvalAmounts = 3;
   */
   ...
   *
   * @generated from field: tokenization.MaxNumTransfers maxNumTransfers = 4;
   */
   ...
   *
   * @generated from field: tokenization.AutoDeletionOptions autoDeletionOptions = 12;
   */
   ...
   *
   * @generated from field: repeated tokenization.MustOwnTokens mustOwnTokens = 14;
   */
   ...
   *
   * @generated from field: repeated tokenization.DynamicStoreChallenge dynamicStoreChallenges = 15;
   */
   ...
   *
   * @generated from field: repeated tokenization.ETHSignatureChallenge ethSignatureChallenges = 16;
   */
   ...
   *
   * @generated from field: tokenization.AddressChecks senderChecks = 17;
   */
   ...
   * specified criteria (e.g., whitelist, blacklist, protocol address requirements).
   *
   * @generated from field: tokenization.AddressChecks recipientChecks = 18;
   */
   ...
   * specified criteria (e.g., whitelist, blacklist, protocol address requirements).
   *
   * @generated from field: tokenization.AddressChecks initiatorChecks = 19;
   */
   ...
   *
   * @generated from field: tokenization.AltTimeChecks altTimeChecks = 20;
   */
   ...
   *
   * @generated from field: repeated tokenization.VotingChallenge votingChallenges = 22;
   */
   ...
   *
   * @generated from field: repeated tokenization.EVMQueryChallenge evmQueryChallenges = 25;
   */
  evmQueryChallenges: EVMQueryChallenge[] = [];

  /**
   * Issuer-imposed constraints on user-level coin transfers. Propagated to user-level approvals
   * during greedy transfer matching (same pattern as userRoyalties). Only applicable on collection-level approvals.
   * If conflicting settings across multiple matched approvals, the transfer is rejected (like royalties).
   *
   * @generated from field: tokenization.UserApprovalSettings userApprovalSettings = 26;
   */
  ...
  static readonly typeName = "tokenization.ApprovalCriteria";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 25, name: "evmQueryChallenges", kind: "message", T: EVMQueryChallenge, repeated: true },
    { no: 26, name: "userApprovalSettings", kind: "message", T: UserApprovalSettings },
  ]);
 ...
 * All criteria must be satisfied for the approval to be considered valid.
 *
 * @generated from message tokenization.OutgoingApprovalCriteria
 */
export class OutgoingApprovalCriteria extends Message<OutgoingApprovalCriteria> {
   ...
   * automatically deleted (e.g., after a certain number of uses or time period).
   *
   * @generated from field: tokenization.AutoDeletionOptions autoDeletionOptions = 8;
   */
  autoDeletionOptions?: AutoDeletionOptions;
   ...
   * the approval to be valid. The initiator must own the specified tokens at the specified ownership times.
   *
   * @generated from field: repeated tokenization.MustOwnTokens mustOwnTokens = 9;
   */
  mustOwnTokens: MustOwnTokens[] = [];
   ...
   * valid proofs that satisfy all specified dynamic store challenges (e.g., key-value store lookups).
   *
   * @generated from field: repeated tokenization.DynamicStoreChallenge dynamicStoreChallenges = 10;
   */
  dynamicStoreChallenges: DynamicStoreChallenge[] = [];
   ...
   * valid Ethereum signatures for all specified challenges. Each signature can only be used once.
   *
   * @generated from field: repeated tokenization.ETHSignatureChallenge ethSignatureChallenges = 11;
   */
  ethSignatureChallenges: ETHSignatureChallenge[] = [];
   ...
   *
   * @generated from field: tokenization.AddressChecks recipientChecks = 12;
   */
  recipientChecks?: AddressChecks;
   ...
   * specified criteria (e.g., whitelist, blacklist, protocol address requirements).
   *
   * @generated from field: tokenization.AddressChecks initiatorChecks = 13;
   */
  initiatorChecks?: AddressChecks;
   ...
   * during which this approval should be denied, such as specific hours of the day or days of the week.
   *
   * @generated from field: tokenization.AltTimeChecks altTimeChecks = 14;
   */
  altTimeChecks?: AltTimeChecks;
   ...
   * valid votes that meet the quorum threshold for all specified challenges.
   *
   * @generated from field: repeated tokenization.VotingChallenge votingChallenges = 16;
   */
  votingChallenges: VotingChallenge[] = [];
   ...
   * that verify external EVM state (e.g., token ownership in another contract).
   *
   * @generated from field: repeated tokenization.EVMQueryChallenge evmQueryChallenges = 17;
   */
  evmQueryChallenges: EVMQueryChallenge[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.OutgoingApprovalCriteria";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "merkleChallenges", kind: "message", T: MerkleChallenge, repeated: true },
    { no: 2, name: "predeterminedBalances", kind: "message", T: PredeterminedBalances },
    { no: 3, name: "approvalAmounts", kind: "message", T: ApprovalAmounts },
    ...
    { no: 17, name: "evmQueryChallenges", kind: "message", T: EVMQueryChallenge, repeated: true },
  ]);
 ...
 * All criteria must be satisfied for the approval to be considered valid.
 *
 * @generated from message tokenization.IncomingApprovalCriteria
 */
export class IncomingApprovalCriteria extends Message<IncomingApprovalCriteria> {
   ...
   *
   * @generated from field: tokenization.AddressChecks senderChecks = 12;
   */
  senderChecks?: AddressChecks;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.IncomingApprovalCriteria";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "merkleChallenges", kind: "message", T: MerkleChallenge, repeated: true },
    { no: 2, name: "predeterminedBalances", kind: "message", T: PredeterminedBalances },
    { no: 3, name: "approvalAmounts", kind: "message", T: ApprovalAmounts },
