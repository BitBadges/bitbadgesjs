...
// @generated from file tokenization/challenges.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message tokenization.MerkleChallenge
 */
export class MerkleChallenge extends Message<MerkleChallenge> {
  ...
  static readonly typeName = "tokenization.MerkleChallenge";
 ...
 * We recommend using a unique challenge ID for each challenge to prevent overlap and unexpected behavior.
 *
 * @generated from message tokenization.ETHSignatureChallenge
 */
export class ETHSignatureChallenge extends Message<ETHSignatureChallenge> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ETHSignatureChallenge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MerklePathItem
 */
export class MerklePathItem extends Message<MerklePathItem> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MerklePathItem";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.MerkleProof
 */
export class MerkleProof extends Message<MerkleProof> {
   ...
   *
   * @generated from field: repeated tokenization.MerklePathItem aunts = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.MerkleProof";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.ETHSignatureProof
 */
export class ETHSignatureProof extends Message<ETHSignatureProof> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ETHSignatureProof";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.VotingChallenge
 */
export class VotingChallenge extends Message<VotingChallenge> {
   ...
   *
   * @generated from field: repeated tokenization.Voter voters = 3;
   */
  voters: Voter[] = [];
   ...
   * This makes the challenge reusable (e.g., for vault withdrawals that need fresh approval each time).
   *
   * @generated from field: bool resetAfterExecution = 6;
   */
   ...
   * During the delay, signers can remove their votes to cancel (quorum drops = delay resets).
   *
   * @generated from field: string delayAfterQuorum = 7;
   */
  delayAfterQuorum = "";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.VotingChallenge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "resetAfterExecution", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 7, name: "delayAfterQuorum", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.Voter
 */
export class Voter extends Message<Voter> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.Voter";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.VoteProof
 */
export class VoteProof extends Message<VoteProof> {
   ...
   *
   * @generated from field: string votedAt = 4;
   */
  votedAt = "";
 ...
 *
 * @generated from message tokenization.VotingChallengeTracker
 */
export class VotingChallengeTracker extends Message<VotingChallengeTracker> {
  /**
   * Timestamp (unix ms) when quorum was first reached. Cleared when quorum drops or after reset.
   *
   * @generated from field: string quorumReachedTimestamp = 1;
   */
  quorumReachedTimestamp = "";

  constructor(data?: PartialMessage<VotingChallengeTracker>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.VotingChallengeTracker";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quorumReachedTimestamp", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): VotingChallengeTracker {
    return new VotingChallengeTracker().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): VotingChallengeTracker {
    return new VotingChallengeTracker().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): VotingChallengeTracker {
    return new VotingChallengeTracker().fromJsonString(jsonString, options);
  }

  static equals(a: VotingChallengeTracker | PlainMessage<VotingChallengeTracker> | undefined, b: VotingChallengeTracker | PlainMessage<VotingChallengeTracker> | undefined): boolean {
    return proto3.util.equals(VotingChallengeTracker, a, b);
  }
}
 ...
 *
 * @generated from message tokenization.EVMQueryChallenge
 */
export class EVMQueryChallenge extends Message<EVMQueryChallenge> {
  /**
   ...
   * Can use placeholders: $initiator, $sender, $recipient (replaced at runtime)
   *
   ...
   *
   * @generated from field: string expectedResult = 3;
   */
  expectedResult = "";
   ...
   *
   * @generated from field: string comparisonOperator = 4;
   */
  comparisonOperator = "";
   ...
   *
   * @generated from field: string gasLimit = 5;
   */
  gasLimit = "";
  ...
  constructor(data?: PartialMessage<EVMQueryChallenge>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.EVMQueryChallenge";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "contractAddress", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "calldata", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "expectedResult", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "comparisonOperator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "gasLimit", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 6, name: "uri", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "customData", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): EVMQueryChallenge {
    return new EVMQueryChallenge().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): EVMQueryChallenge {
    return new EVMQueryChallenge().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): EVMQueryChallenge {
    return new EVMQueryChallenge().fromJsonString(jsonString, options);
  }

  static equals(a: EVMQueryChallenge | PlainMessage<EVMQueryChallenge> | undefined, b: EVMQueryChallenge | PlainMessage<EVMQueryChallenge> | undefined): boolean {
    return proto3.util.equals(EVMQueryChallenge, a, b);
  }
}
