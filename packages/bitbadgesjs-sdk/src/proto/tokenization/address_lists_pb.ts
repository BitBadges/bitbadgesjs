...
// @generated from file tokenization/address_lists.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message tokenization.AddressList
 */
export class AddressList extends Message<AddressList> {
  ...
  static readonly typeName = "tokenization.AddressList";
 ...
 *
 * @generated from message tokenization.AddressListInput
 */
export class AddressListInput extends Message<AddressListInput> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.AddressListInput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "listId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "addresses", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 3, name: "whitelist", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
