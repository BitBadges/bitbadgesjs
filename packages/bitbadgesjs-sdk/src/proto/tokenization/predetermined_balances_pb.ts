...
// @generated from file tokenization/predetermined_balances.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message tokenization.ManualBalances
 */
export class ManualBalances extends Message<ManualBalances> {
  ...
  static readonly typeName = "tokenization.ManualBalances";
 ...
 *
 * @generated from message tokenization.RecurringOwnershipTimes
 */
export class RecurringOwnershipTimes extends Message<RecurringOwnershipTimes> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.RecurringOwnershipTimes";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.IncrementedBalances
 */
export class IncrementedBalances extends Message<IncrementedBalances> {
  /**
   * @generated from field: repeated tokenization.Balance startBalances = 1;
   */
   ...
   *
   * @generated from field: tokenization.RecurringOwnershipTimes recurringOwnershipTimes = 6;
   */
   ...
   *
   * @generated from field: string maxScalingMultiplier = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.IncrementedBalances";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "maxScalingMultiplier", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message tokenization.PredeterminedOrderCalculationMethod
 */
export class PredeterminedOrderCalculationMethod extends Message<PredeterminedOrderCalculationMethod> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.PredeterminedOrderCalculationMethod";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.PredeterminedBalances
 */
export class PredeterminedBalances extends Message<PredeterminedBalances> {
   ...
   *
   * @generated from field: repeated tokenization.ManualBalances manualBalances = 1;
   */
   ...
   *
   * @generated from field: tokenization.IncrementedBalances incrementedBalances = 2;
   */
   ...
   *
   * @generated from field: tokenization.PredeterminedOrderCalculationMethod orderCalculationMethod = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.PredeterminedBalances";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
