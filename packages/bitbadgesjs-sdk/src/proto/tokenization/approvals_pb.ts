...
// @generated from file tokenization/approvals.proto (package tokenization, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message tokenization.CollectionApproval
 */
export class CollectionApproval extends Message<CollectionApproval> {
   ...
   *
   * @generated from field: tokenization.ApprovalCriteria approvalCriteria = 10;
   */
  ...
  static readonly typeName = "tokenization.CollectionApproval";
 ...
 *
 * @generated from message tokenization.UserOutgoingApproval
 */
export class UserOutgoingApproval extends Message<UserOutgoingApproval> {
   ...
   * The criteria that must be met for this approval to be considered.
   *
   * @generated from field: tokenization.OutgoingApprovalCriteria approvalCriteria = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.UserOutgoingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tokenization.UserIncomingApproval
 */
export class UserIncomingApproval extends Message<UserIncomingApproval> {
   ...
   * The criteria that must be met for this approval to be considered.
   *
   * @generated from field: tokenization.IncomingApprovalCriteria approvalCriteria = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.UserIncomingApproval";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "fromListId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "initiatedByListId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "transferTimes", kind: "message", T: UintRange, repeated: true },
 ...
 *
 * @generated from message tokenization.ApprovalIdentifierDetails
 */
export class ApprovalIdentifierDetails extends Message<ApprovalIdentifierDetails> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tokenization.ApprovalIdentifierDetails";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
