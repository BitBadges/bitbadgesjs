...
export class QueryWasmxParamsRequest extends Message<QueryWasmxParamsRequest> {
  ...
  static equals(
    a: QueryWasmxParamsRequest | PlainMessage<QueryWasmxParamsRequest> | undefined,
    b: QueryWasmxParamsRequest | PlainMessage<QueryWasmxParamsRequest> | undefined
  ): boolean {
...
export class QueryWasmxParamsResponse extends Message<QueryWasmxParamsResponse> {
  ...
  static equals(
    a: QueryWasmxParamsResponse | PlainMessage<QueryWasmxParamsResponse> | undefined,
    b: QueryWasmxParamsResponse | PlainMessage<QueryWasmxParamsResponse> | undefined
  ): boolean {
...
export class QueryModuleStateRequest extends Message<QueryModuleStateRequest> {
  ...
  static equals(
    a: QueryModuleStateRequest | PlainMessage<QueryModuleStateRequest> | undefined,
    b: QueryModuleStateRequest | PlainMessage<QueryModuleStateRequest> | undefined
  ): boolean {
...
export class QueryModuleStateResponse extends Message<QueryModuleStateResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'state', kind: 'message', T: GenesisState }]);
  ...
  static equals(
    a: QueryModuleStateResponse | PlainMessage<QueryModuleStateResponse> | undefined,
    b: QueryModuleStateResponse | PlainMessage<QueryModuleStateResponse> | undefined
  ): boolean {
