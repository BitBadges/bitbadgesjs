...
export class GenesisState extends Message<GenesisState> {
  ...
  /**
   * @generated from field: repeated string pending_recv_packet_sequence_numbers = 6;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "pending_recv_packet_sequence_numbers", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
