...
export class GenesisState extends Message<GenesisState> {
  /**
   * @generated from field: ibc.applications.interchain_accounts.v1.ControllerGenesisState controller_genesis_state = 1;
   */
  controllerGenesisState?: ControllerGenesisState;

  /**
   * @generated from field: ibc.applications.interchain_accounts.v1.HostGenesisState host_genesis_state = 2;
   */
...
export class ControllerGenesisState extends Message<ControllerGenesisState> {
  /**
   * @generated from field: repeated ibc.applications.interchain_accounts.v1.ActiveChannel active_channels = 1;
   */
  activeChannels: ActiveChannel[] = [];

  /**
   * @generated from field: repeated ibc.applications.interchain_accounts.v1.RegisteredInterchainAccount interchain_accounts = 2;
   */
