...
import { CollectionMetadata, OffChainBalancesMetadata, TokenMetadata } from "./metadata_pb.js";
 ...
 *
 * @generated from message badges.TokenMetadataTimeline
 */
export class TokenMetadataTimeline extends Message<TokenMetadataTimeline> {
   ...
   *
   * @generated from field: repeated badges.TokenMetadata tokenMetadata = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "badges.TokenMetadataTimeline";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
