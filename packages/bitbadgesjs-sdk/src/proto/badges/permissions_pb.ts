...
export class CollectionPermissions extends Message<CollectionPermissions> {
  ...
  static equals(
    a: CollectionPermissions | PlainMessage<CollectionPermissions> | undefined,
    b: CollectionPermissions | PlainMessage<CollectionPermissions> | undefined
  ): boolean {
...
export class UserPermissions extends Message<UserPermissions> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 3,
      name: 'canUpdateAutoApproveSelfInitiatedOutgoingTransfers',
      kind: 'message',
      T: ActionPermission,
      repeated: true
    },
    {
      no: 4,
      name: 'canUpdateAutoApproveSelfInitiatedIncomingTransfers',
      kind: 'message',
      T: ActionPermission,
      repeated: true
    }
  ...
  static equals(
    a: UserPermissions | PlainMessage<UserPermissions> | undefined,
    b: UserPermissions | PlainMessage<UserPermissions> | undefined
  ): boolean {
...
export class CollectionApprovalPermission extends Message<CollectionApprovalPermission> {
  ...
  static equals(
    a: CollectionApprovalPermission | PlainMessage<CollectionApprovalPermission> | undefined,
    b: CollectionApprovalPermission | PlainMessage<CollectionApprovalPermission> | undefined
  ): boolean {
...
export class UserOutgoingApprovalPermission extends Message<UserOutgoingApprovalPermission> {
  ...
  static equals(
    a: UserOutgoingApprovalPermission | PlainMessage<UserOutgoingApprovalPermission> | undefined,
    b: UserOutgoingApprovalPermission | PlainMessage<UserOutgoingApprovalPermission> | undefined
  ): boolean {
...
export class UserIncomingApprovalPermission extends Message<UserIncomingApprovalPermission> {
  ...
  static equals(
    a: UserIncomingApprovalPermission | PlainMessage<UserIncomingApprovalPermission> | undefined,
    b: UserIncomingApprovalPermission | PlainMessage<UserIncomingApprovalPermission> | undefined
  ): boolean {
...
export class BalancesActionPermission extends Message<BalancesActionPermission> {
  ...
  static equals(
    a: BalancesActionPermission | PlainMessage<BalancesActionPermission> | undefined,
    b: BalancesActionPermission | PlainMessage<BalancesActionPermission> | undefined
  ): boolean {
...
export class ActionPermission extends Message<ActionPermission> {
  ...
  static equals(
    a: ActionPermission | PlainMessage<ActionPermission> | undefined,
    b: ActionPermission | PlainMessage<ActionPermission> | undefined
  ): boolean {
...
export class TimedUpdatePermission extends Message<TimedUpdatePermission> {
  ...
  static equals(
    a: TimedUpdatePermission | PlainMessage<TimedUpdatePermission> | undefined,
    b: TimedUpdatePermission | PlainMessage<TimedUpdatePermission> | undefined
  ): boolean {
...
export class TimedUpdateWithBadgeIdsPermission extends Message<TimedUpdateWithBadgeIdsPermission> {
  ...
  static equals(
    a: TimedUpdateWithBadgeIdsPermission | PlainMessage<TimedUpdateWithBadgeIdsPermission> | undefined,
    b: TimedUpdateWithBadgeIdsPermission | PlainMessage<TimedUpdateWithBadgeIdsPermission> | undefined
  ): boolean {
