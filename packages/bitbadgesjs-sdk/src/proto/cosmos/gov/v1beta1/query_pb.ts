...
export class QueryProposalsResponse extends Message<QueryProposalsResponse> {
  ...
  static equals(
    a: QueryProposalsResponse | PlainMessage<QueryProposalsResponse> | undefined,
    b: QueryProposalsResponse | PlainMessage<QueryProposalsResponse> | undefined
  ): boolean {
...
export class QueryParamsRequest extends Message<QueryParamsRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'params_type', kind: 'scalar', T: 9 /* ScalarType.STRING */ }]);
...
export class QueryDepositResponse extends Message<QueryDepositResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'deposit', kind: 'message', T: Deposit }]);
