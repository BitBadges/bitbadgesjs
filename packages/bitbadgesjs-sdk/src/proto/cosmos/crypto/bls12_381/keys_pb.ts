...
// @generated from file cosmos/crypto/bls12_381/keys.proto (package cosmos.crypto.bls12_381, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cosmos.crypto.bls12_381.PubKey
 */
export class PubKey extends Message<PubKey> {
  ...
  static readonly typeName = "cosmos.crypto.bls12_381.PubKey";
 ...
 *
 * @generated from message cosmos.crypto.bls12_381.PrivKey
 */
export class PrivKey extends Message<PrivKey> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.crypto.bls12_381.PrivKey";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "key", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
