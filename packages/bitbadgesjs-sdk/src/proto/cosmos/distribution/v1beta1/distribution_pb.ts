...
export class ValidatorHistoricalRewards extends Message<ValidatorHistoricalRewards> {
  ...
  static equals(
    a: ValidatorHistoricalRewards | PlainMessage<ValidatorHistoricalRewards> | undefined,
    b: ValidatorHistoricalRewards | PlainMessage<ValidatorHistoricalRewards> | undefined
  ): boolean {
...
export class ValidatorCurrentRewards extends Message<ValidatorCurrentRewards> {
  ...
  static equals(
    a: ValidatorCurrentRewards | PlainMessage<ValidatorCurrentRewards> | undefined,
    b: ValidatorCurrentRewards | PlainMessage<ValidatorCurrentRewards> | undefined
  ): boolean {
...
export class ValidatorAccumulatedCommission extends Message<ValidatorAccumulatedCommission> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'commission', kind: 'message', T: DecCoin, repeated: true }]);
  ...
  static equals(
    a: ValidatorAccumulatedCommission | PlainMessage<ValidatorAccumulatedCommission> | undefined,
    b: ValidatorAccumulatedCommission | PlainMessage<ValidatorAccumulatedCommission> | undefined
  ): boolean {
...
export class ValidatorOutstandingRewards extends Message<ValidatorOutstandingRewards> {
  ...
  static equals(
    a: ValidatorOutstandingRewards | PlainMessage<ValidatorOutstandingRewards> | undefined,
    b: ValidatorOutstandingRewards | PlainMessage<ValidatorOutstandingRewards> | undefined
  ): boolean {
...
export class CommunityPoolSpendProposal extends Message<CommunityPoolSpendProposal> {
  ...
  static equals(
    a: CommunityPoolSpendProposal | PlainMessage<CommunityPoolSpendProposal> | undefined,
    b: CommunityPoolSpendProposal | PlainMessage<CommunityPoolSpendProposal> | undefined
  ): boolean {
...
export class DelegationDelegatorReward extends Message<DelegationDelegatorReward> {
  ...
  static equals(
    a: DelegationDelegatorReward | PlainMessage<DelegationDelegatorReward> | undefined,
    b: DelegationDelegatorReward | PlainMessage<DelegationDelegatorReward> | undefined
  ): boolean {
...
export class CommunityPoolSpendProposalWithDeposit extends Message<CommunityPoolSpendProposalWithDeposit> {
  ...
  static equals(
    a: CommunityPoolSpendProposalWithDeposit | PlainMessage<CommunityPoolSpendProposalWithDeposit> | undefined,
    b: CommunityPoolSpendProposalWithDeposit | PlainMessage<CommunityPoolSpendProposalWithDeposit> | undefined
  ): boolean {
