...
export class TableDescriptor extends Message<TableDescriptor> {
  ...
  static equals(
    a: TableDescriptor | PlainMessage<TableDescriptor> | undefined,
    b: TableDescriptor | PlainMessage<TableDescriptor> | undefined
  ): boolean {
...
export class PrimaryKeyDescriptor extends Message<PrimaryKeyDescriptor> {
  ...
  static equals(
    a: PrimaryKeyDescriptor | PlainMessage<PrimaryKeyDescriptor> | undefined,
    b: PrimaryKeyDescriptor | PlainMessage<PrimaryKeyDescriptor> | undefined
  ): boolean {
...
export class SecondaryIndexDescriptor extends Message<SecondaryIndexDescriptor> {
  ...
  static equals(
    a: SecondaryIndexDescriptor | PlainMessage<SecondaryIndexDescriptor> | undefined,
    b: SecondaryIndexDescriptor | PlainMessage<SecondaryIndexDescriptor> | undefined
  ): boolean {
...
export class SingletonDescriptor extends Message<SingletonDescriptor> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'id', kind: 'scalar', T: 13 /* ScalarType.UINT32 */ }]);
  ...
  static equals(
    a: SingletonDescriptor | PlainMessage<SingletonDescriptor> | undefined,
    b: SingletonDescriptor | PlainMessage<SingletonDescriptor> | undefined
  ): boolean {
