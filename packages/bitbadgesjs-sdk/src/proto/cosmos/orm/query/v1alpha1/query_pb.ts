...
export class GetResponse extends Message<GetResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'result', kind: 'message', T: Any }]);
...
export class ListRequest_Prefix extends Message<ListRequest_Prefix> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'values', kind: 'message', T: IndexValue, repeated: true }]);
