 ...
 */
export const module_schema = proto3.makeExtension<MessageOptions, ModuleSchemaDescriptor>(
  "cosmos.orm.v1alpha1.module_schema", 
  MessageOptions, 
  () => ({ no: 104503792, kind: "message", T: ModuleSchemaDescriptor }),
);
