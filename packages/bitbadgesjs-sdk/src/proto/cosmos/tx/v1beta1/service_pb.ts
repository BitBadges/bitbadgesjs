...
export class BroadcastTxResponse extends Message<BroadcastTxResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'tx_response', kind: 'message', T: TxResponse }]);
...
export class GetBlockWithTxsRequest extends Message<GetBlockWithTxsRequest> {
  ...
  static equals(
    a: GetBlockWithTxsRequest | PlainMessage<GetBlockWithTxsRequest> | undefined,
    b: GetBlockWithTxsRequest | PlainMessage<GetBlockWithTxsRequest> | undefined
  ): boolean {
...
export class GetBlockWithTxsResponse extends Message<GetBlockWithTxsResponse> {
  ...
  static equals(
    a: GetBlockWithTxsResponse | PlainMessage<GetBlockWithTxsResponse> | undefined,
    b: GetBlockWithTxsResponse | PlainMessage<GetBlockWithTxsResponse> | undefined
  ): boolean {
...
export class TxDecodeRequest extends Message<TxDecodeRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'tx_bytes', kind: 'scalar', T: 12 /* ScalarType.BYTES */ }]);
...
export class TxDecodeResponse extends Message<TxDecodeResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'tx', kind: 'message', T: Tx }]);
...
export class TxEncodeAminoRequest extends Message<TxEncodeAminoRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'amino_json', kind: 'scalar', T: 9 /* ScalarType.STRING */ }]);
...
export class TxEncodeAminoResponse extends Message<TxEncodeAminoResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'amino_binary', kind: 'scalar', T: 12 /* ScalarType.BYTES */ }]);
