...
export class DVPairs extends Message<DVPairs> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'pairs', kind: 'message', T: DVPair, repeated: true }]);
...
export class DVVTriplets extends Message<DVVTriplets> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'triplets', kind: 'message', T: DVVTriplet, repeated: true }]);
...
export class UnbondingDelegationEntry extends Message<UnbondingDelegationEntry> {
  ...
  static equals(
    a: UnbondingDelegationEntry | PlainMessage<UnbondingDelegationEntry> | undefined,
    b: UnbondingDelegationEntry | PlainMessage<UnbondingDelegationEntry> | undefined
  ): boolean {
...
export class RedelegationEntryResponse extends Message<RedelegationEntryResponse> {
  ...
  static equals(
    a: RedelegationEntryResponse | PlainMessage<RedelegationEntryResponse> | undefined,
    b: RedelegationEntryResponse | PlainMessage<RedelegationEntryResponse> | undefined
  ): boolean {
