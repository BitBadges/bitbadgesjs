...
export class MsgCreateValidatorResponse extends Message<MsgCreateValidatorResponse> {
  ...
  static equals(
    a: MsgCreateValidatorResponse | PlainMessage<MsgCreateValidatorResponse> | undefined,
    b: MsgCreateValidatorResponse | PlainMessage<MsgCreateValidatorResponse> | undefined
  ): boolean {
...
export class MsgEditValidatorResponse extends Message<MsgEditValidatorResponse> {
  ...
  static equals(
    a: MsgEditValidatorResponse | PlainMessage<MsgEditValidatorResponse> | undefined,
    b: MsgEditValidatorResponse | PlainMessage<MsgEditValidatorResponse> | undefined
  ): boolean {
...
export class MsgBeginRedelegateResponse extends Message<MsgBeginRedelegateResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'completion_time', kind: 'message', T: Timestamp }]);
  ...
  static equals(
    a: MsgBeginRedelegateResponse | PlainMessage<MsgBeginRedelegateResponse> | undefined,
    b: MsgBeginRedelegateResponse | PlainMessage<MsgBeginRedelegateResponse> | undefined
  ): boolean {
...
export class MsgCancelUnbondingDelegation extends Message<MsgCancelUnbondingDelegation> {
  ...
  static equals(
    a: MsgCancelUnbondingDelegation | PlainMessage<MsgCancelUnbondingDelegation> | undefined,
    b: MsgCancelUnbondingDelegation | PlainMessage<MsgCancelUnbondingDelegation> | undefined
  ): boolean {
...
export class MsgCancelUnbondingDelegationResponse extends Message<MsgCancelUnbondingDelegationResponse> {
  ...
  static equals(
    a: MsgCancelUnbondingDelegationResponse | PlainMessage<MsgCancelUnbondingDelegationResponse> | undefined,
    b: MsgCancelUnbondingDelegationResponse | PlainMessage<MsgCancelUnbondingDelegationResponse> | undefined
  ): boolean {
