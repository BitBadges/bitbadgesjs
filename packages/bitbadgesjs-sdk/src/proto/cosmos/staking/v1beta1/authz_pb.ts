...
export class StakeAuthorization_Validators extends Message<StakeAuthorization_Validators> {
  ...
  static equals(
    a: StakeAuthorization_Validators | PlainMessage<StakeAuthorization_Validators> | undefined,
    b: StakeAuthorization_Validators | PlainMessage<StakeAuthorization_Validators> | undefined
  ): boolean {
