...
export class MsgSoftwareUpgradeResponse extends Message<MsgSoftwareUpgradeResponse> {
  ...
  static equals(
    a: MsgSoftwareUpgradeResponse | PlainMessage<MsgSoftwareUpgradeResponse> | undefined,
    b: MsgSoftwareUpgradeResponse | PlainMessage<MsgSoftwareUpgradeResponse> | undefined
  ): boolean {
...
export class MsgCancelUpgrade extends Message<MsgCancelUpgrade> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 1, name: 'authority', kind: 'scalar', T: 9 /* ScalarType.STRING */ }]);
...
export class MsgCancelUpgradeResponse extends Message<MsgCancelUpgradeResponse> {
  ...
  static equals(
    a: MsgCancelUpgradeResponse | PlainMessage<MsgCancelUpgradeResponse> | undefined,
    b: MsgCancelUpgradeResponse | PlainMessage<MsgCancelUpgradeResponse> | undefined
  ): boolean {
