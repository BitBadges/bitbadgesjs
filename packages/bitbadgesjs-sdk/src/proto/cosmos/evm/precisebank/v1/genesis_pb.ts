...
// @generated from file cosmos/evm/precisebank/v1/genesis.proto (package cosmos.evm.precisebank.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cosmos.evm.precisebank.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  /**
   * balances is a list of all the balances in the precisebank module.
   *
   * @generated from field: repeated cosmos.evm.precisebank.v1.FractionalBalance balances = 1;
   */
  ...
  static readonly typeName = "cosmos.evm.precisebank.v1.GenesisState";
 ...
 *
 * @generated from message cosmos.evm.precisebank.v1.FractionalBalance
 */
export class FractionalBalance extends Message<FractionalBalance> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.precisebank.v1.FractionalBalance";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
