...
// @generated from file cosmos/evm/erc20/v1/events.proto (package cosmos.evm.erc20.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.EventRegisterPair
 */
export class EventRegisterPair extends Message<EventRegisterPair> {
  ...
  static readonly typeName = "cosmos.evm.erc20.v1.EventRegisterPair";
 ...
 * is toggled.
 *
 * @generated from message cosmos.evm.erc20.v1.EventToggleTokenConversion
 */
export class EventToggleTokenConversion extends Message<EventToggleTokenConversion> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.EventToggleTokenConversion";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "denom", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "erc20_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.EventConvertCoin
 */
export class EventConvertCoin extends Message<EventConvertCoin> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.EventConvertCoin";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.EventConvertERC20
 */
export class EventConvertERC20 extends Message<EventConvertERC20> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.EventConvertERC20";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sender", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "receiver", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
