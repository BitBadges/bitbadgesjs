...
// @generated from file cosmos/evm/erc20/v1/erc20.proto (package cosmos.evm.erc20.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { Metadata } from "../../../bank/v1beta1/bank_pb.js";

/**
 * Owner enumerates the ownership of a ERC20 contract.
 *
 * @generated from enum cosmos.evm.erc20.v1.Owner
 */
export enum Owner {
  /**
...
proto3.util.setEnumType(Owner, "cosmos.evm.erc20.v1.Owner", [
...
export class TokenPair extends Message<TokenPair> {
   ...
   *
   * @generated from field: cosmos.evm.erc20.v1.Owner contract_owner = 4;
   */
  ...
  static readonly typeName = "cosmos.evm.erc20.v1.TokenPair";
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.Allowance
 */
export class Allowance extends Message<Allowance> {
  /**
  ...
  constructor(data?: PartialMessage<Allowance>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.Allowance";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "erc20_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "owner", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "spender", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "value", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Allowance {
    return new Allowance().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Allowance {
    return new Allowance().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Allowance {
    return new Allowance().fromJsonString(jsonString, options);
  }

  static equals(a: Allowance | PlainMessage<Allowance> | undefined, b: Allowance | PlainMessage<Allowance> | undefined): boolean {
    return proto3.util.equals(Allowance, a, b);
  }
}
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.RegisterCoinProposal
 */
export class RegisterCoinProposal extends Message<RegisterCoinProposal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.RegisterCoinProposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message cosmos.evm.erc20.v1.ProposalMetadata
 */
export class ProposalMetadata extends Message<ProposalMetadata> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.ProposalMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * NOTE: Keep this message for backwards compatibility on proposals query
 *
 * @generated from message cosmos.evm.erc20.v1.RegisterERC20Proposal
 */
export class RegisterERC20Proposal extends Message<RegisterERC20Proposal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.RegisterERC20Proposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * NOTE: Keep this message for backwards compatibility on proposals query
 *
 * @generated from message cosmos.evm.erc20.v1.ToggleTokenConversionProposal
 */
export class ToggleTokenConversionProposal extends Message<ToggleTokenConversionProposal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.erc20.v1.ToggleTokenConversionProposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
