...
// @generated from file cosmos/evm/crypto/v1/ethsecp256k1/keys.proto (package cosmos.evm.crypto.v1.ethsecp256k1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * key format.
 *
 * @generated from message cosmos.evm.crypto.v1.ethsecp256k1.PubKey
 */
export class PubKey extends Message<PubKey> {
  ...
  static readonly typeName = "cosmos.evm.crypto.v1.ethsecp256k1.PubKey";
 ...
 *
 * @generated from message cosmos.evm.crypto.v1.ethsecp256k1.PrivKey
 */
export class PrivKey extends Message<PrivKey> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.crypto.v1.ethsecp256k1.PrivKey";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "key", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
