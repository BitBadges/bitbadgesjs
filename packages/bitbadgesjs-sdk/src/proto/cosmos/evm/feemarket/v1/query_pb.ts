...
// @generated from file cosmos/evm/feemarket/v1/query.proto (package cosmos.evm.feemarket.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryParamsRequest
 */
export class QueryParamsRequest extends Message<QueryParamsRequest> {
  ...
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryParamsRequest";
 ...
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryParamsResponse
 */
export class QueryParamsResponse extends Message<QueryParamsResponse> {
  /**
   * params define the evm module parameters.
   *
   * @generated from field: cosmos.evm.feemarket.v1.Params params = 1;
   */
  params?: Params;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryParamsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * fee.
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryBaseFeeRequest
 */
export class QueryBaseFeeRequest extends Message<QueryBaseFeeRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryBaseFeeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryBaseFeeResponse
 */
export class QueryBaseFeeResponse extends Message<QueryBaseFeeResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryBaseFeeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * fee.
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryBlockGasRequest
 */
export class QueryBlockGasRequest extends Message<QueryBlockGasRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryBlockGasRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message cosmos.evm.feemarket.v1.QueryBlockGasResponse
 */
export class QueryBlockGasResponse extends Message<QueryBlockGasResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.feemarket.v1.QueryBlockGasResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
