...
// @generated from file cosmos/evm/server/v1/indexer.proto (package cosmos.evm.server.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message cosmos.evm.server.v1.TxResult
 */
export class TxResult extends Message<TxResult> {
  ...
  static readonly typeName = "cosmos.evm.server.v1.TxResult";
