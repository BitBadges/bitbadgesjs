...
// @generated from file cosmos/evm/vm/v1/genesis.proto (package cosmos.evm.vm.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { Params, Preinstall, State } from "./evm_pb.js";

/**
 * GenesisState defines the evm module's genesis state.
 *
 * @generated from message cosmos.evm.vm.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  /**
   * accounts is an array containing the ethereum genesis accounts.
   *
   * @generated from field: repeated cosmos.evm.vm.v1.GenesisAccount accounts = 1;
   */
   ...
   *
   * @generated from field: repeated cosmos.evm.vm.v1.Preinstall preinstalls = 3;
   */
  ...
  static readonly typeName = "cosmos.evm.vm.v1.GenesisState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "accounts", kind: "message", T: GenesisAccount, repeated: true },
    { no: 2, name: "params", kind: "message", T: Params },
    { no: 3, name: "preinstalls", kind: "message", T: Preinstall, repeated: true },
  ]);
 ...
 *
 * @generated from message cosmos.evm.vm.v1.GenesisAccount
 */
export class GenesisAccount extends Message<GenesisAccount> {
   ...
   *
   * @generated from field: repeated cosmos.evm.vm.v1.State storage = 3;
   */
  storage: State[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.evm.vm.v1.GenesisAccount";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
