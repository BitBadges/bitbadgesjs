...
import { ABCIParams, AuthorityParams, BlockParams, EvidenceParams, ValidatorParams } from "../../../tendermint/types/params_pb.js";
...
export class MsgUpdateParams extends Message<MsgUpdateParams> {
  ...
  /**
   * @generated from field: tendermint.types.AuthorityParams auth = 6;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "auth", kind: "message", T: AuthorityParams },
  ]);
