...
export class MsgSubmitEvidenceResponse extends Message<MsgSubmitEvidenceResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [{ no: 4, name: 'hash', kind: 'scalar', T: 12 /* ScalarType.BYTES */ }]);
  ...
  static equals(
    a: MsgSubmitEvidenceResponse | PlainMessage<MsgSubmitEvidenceResponse> | undefined,
    b: MsgSubmitEvidenceResponse | PlainMessage<MsgSubmitEvidenceResponse> | undefined
  ): boolean {
