 ...
 *
 * @generated from message protocols.ProtocolCustomMsgType
 */
export class ProtocolCustomMsgType extends Message<ProtocolCustomMsgType> {
  /**
   * @generated from field: protocols.MsgCreateProtocol createProtocolMsg = 1;
   */
  createProtocolMsg?: MsgCreateProtocol;

  /**
   * @generated from field: protocols.MsgUpdateProtocol updateProtocolMsg = 2;
   */
  updateProtocolMsg?: MsgUpdateProtocol;

  /**
   * @generated from field: protocols.MsgDeleteProtocol deleteProtocolMsg = 3;
   */
  deleteProtocolMsg?: MsgDeleteProtocol;

  /**
   * @generated from field: protocols.MsgSetCollectionForProtocol setCollectionForProtocolMsg = 4;
   */
  setCollectionForProtocolMsg?: MsgSetCollectionForProtocol;

  /**
   * @generated from field: protocols.MsgUnsetCollectionForProtocol unsetCollectionForProtocolMsg = 5;
   */
  unsetCollectionForProtocolMsg?: MsgUnsetCollectionForProtocol;

  constructor(data?: PartialMessage<ProtocolCustomMsgType>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "protocols.ProtocolCustomMsgType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "createProtocolMsg", kind: "message", T: MsgCreateProtocol },
    { no: 2, name: "updateProtocolMsg", kind: "message", T: MsgUpdateProtocol },
    { no: 3, name: "deleteProtocolMsg", kind: "message", T: MsgDeleteProtocol },
    { no: 4, name: "setCollectionForProtocolMsg", kind: "message", T: MsgSetCollectionForProtocol },
    { no: 5, name: "unsetCollectionForProtocolMsg", kind: "message", T: MsgUnsetCollectionForProtocol },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ProtocolCustomMsgType {
    return new ProtocolCustomMsgType().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ProtocolCustomMsgType {
    return new ProtocolCustomMsgType().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ProtocolCustomMsgType {
    return new ProtocolCustomMsgType().fromJsonString(jsonString, options);
  }

  static equals(a: ProtocolCustomMsgType | PlainMessage<ProtocolCustomMsgType> | undefined, b: ProtocolCustomMsgType | PlainMessage<ProtocolCustomMsgType> | undefined): boolean {
    return proto3.util.equals(ProtocolCustomMsgType, a, b);
  }
}
