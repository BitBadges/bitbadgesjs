...
// @generated from file gamm/v2/query.proto (package gamm.v2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message gamm.v2.QuerySpotPriceRequest
 * @deprecated
 */
export class QuerySpotPriceRequest extends Message<QuerySpotPriceRequest> {
  ...
  static readonly typeName = "gamm.v2.QuerySpotPriceRequest";
 ...
 * Deprecated: please use alternate in x/poolmanager
 *
 * @generated from message gamm.v2.QuerySpotPriceResponse
 * @deprecated
 */
export class QuerySpotPriceResponse extends Message<QuerySpotPriceResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gamm.v2.QuerySpotPriceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
