 ...
 *
 * @generated from message gamm.poolmodels.balancer.SmoothWeightChangeParams
 */
export class SmoothWeightChangeParams extends Message<SmoothWeightChangeParams> {
   ...
   * here.
   *
   * @generated from field: repeated gamm.poolmodels.balancer.PoolAsset initial_pool_weights = 3;
   */
   ...
   * ];
   *
   * @generated from field: repeated gamm.poolmodels.balancer.PoolAsset target_pool_weights = 4;
   */
  ...
  static readonly typeName = "gamm.poolmodels.balancer.SmoothWeightChangeParams";
...
export class PoolParams extends Message<PoolParams> {
  ...
  /**
   * @generated from field: gamm.poolmodels.balancer.SmoothWeightChangeParams smooth_weight_change_params = 3;
   */
...
export class Pool extends Message<Pool> {
   ...
   *
   * @generated from field: repeated gamm.poolmodels.balancer.PoolAsset pool_assets = 6;
   */
