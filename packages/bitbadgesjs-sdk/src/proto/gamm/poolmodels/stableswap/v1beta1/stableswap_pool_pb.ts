...
// @generated from file gamm/poolmodels/stableswap/v1beta1/stableswap_pool.proto (package gamm.poolmodels.stableswap, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message gamm.poolmodels.stableswap.PoolParams
 */
export class PoolParams extends Message<PoolParams> {
  ...
  static readonly typeName = "gamm.poolmodels.stableswap.PoolParams";
 ...
 *
 * @generated from message gamm.poolmodels.stableswap.Pool
 */
export class Pool extends Message<Pool> {
  ...
  /**
   * @generated from field: gamm.poolmodels.stableswap.PoolParams pool_params = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gamm.poolmodels.stableswap.Pool";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
