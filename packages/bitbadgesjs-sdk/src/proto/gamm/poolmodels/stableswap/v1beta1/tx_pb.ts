...
// @generated from file gamm/poolmodels/stableswap/v1beta1/tx.proto (package gamm.poolmodels.stableswap, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * ===================== MsgCreatePool
 *
 * @generated from message gamm.poolmodels.stableswap.MsgCreateStableswapPool
 */
export class MsgCreateStableswapPool extends Message<MsgCreateStableswapPool> {
  ...
  /**
   * @generated from field: gamm.poolmodels.stableswap.PoolParams pool_params = 2;
   */
  ...
  static readonly typeName = "gamm.poolmodels.stableswap.MsgCreateStableswapPool";
 ...
 *
 * @generated from message gamm.poolmodels.stableswap.MsgCreateStableswapPoolResponse
 */
export class MsgCreateStableswapPoolResponse extends Message<MsgCreateStableswapPoolResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gamm.poolmodels.stableswap.MsgCreateStableswapPoolResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message gamm.poolmodels.stableswap.MsgStableSwapAdjustScalingFactors
 */
export class MsgStableSwapAdjustScalingFactors extends Message<MsgStableSwapAdjustScalingFactors> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gamm.poolmodels.stableswap.MsgStableSwapAdjustScalingFactors";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sender", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message gamm.poolmodels.stableswap.MsgStableSwapAdjustScalingFactorsResponse
 */
export class MsgStableSwapAdjustScalingFactorsResponse extends Message<MsgStableSwapAdjustScalingFactorsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gamm.poolmodels.stableswap.MsgStableSwapAdjustScalingFactorsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
