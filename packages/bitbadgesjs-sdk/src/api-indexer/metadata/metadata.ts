 ...
 */
export const DEFAULT_PLACEHOLDER_IMAGE_URI = 'ipfs://QmdZH9YT1GoMRsiCqSsJi57bmZiV2C6bCT8r8tZHeULDKS';

/**
 * Canonical placeholder metadata JSON (pinned 2026-05-11).
 * `{ name: 'Untitled', description: 'No description provided.', image: <DEFAULT_PLACEHOLDER_IMAGE_URI> }`
 */
export const DEFAULT_PLACEHOLDER_METADATA_URI = 'ipfs://QmUxjBw4jm1QHKPYyQmekwFxe3dkNo8argPKg5dKRj6VYW';
...
export class Metadata<T extends NumberType> extends BaseNumberTypeClass<Metadata<T>> implements iMetadata<T> {
  ...
  static DefaultPlaceholderMetadata = () =>
    new Metadata({
      ...
      image: DEFAULT_PLACEHOLDER_IMAGE_URI
    }).convert(BigIntify);
