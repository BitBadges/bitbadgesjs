 ...
 * @property {boolean} mustSatisfyForAllAssets - Whether or not the user must own all the sepcified badges. If false, we will accept if they own at least one for >= 1 millisecond.
 */
 ...
 * @property {string} listId - The ID of the address list.
 * @property {string[]} addresses - The addresses of the address list.
 * @property {boolean} whitelist - Whether or not to include ONLY the addresses or include all EXCEPT the addresses.
 * @property {string} uri - The URI where to fetch the address list metadata from.
 * @property {string} customData - Arbitrary custom data that can be stored on-chain.
 * @property {string} createdBy - The address that created the address list.
 * @property {string} aliasAddress - The alias cosmos address of the address list.
 */
