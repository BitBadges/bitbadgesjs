...
//TODO: clean this
/**
 * Safe adds two numbers and returns an error if the result overflows.
 *
 * Note this overflows for Number.MAX_SAFE_INTEGER which is 2^53 - 1.
 * The blockchain uses uint64 which is 2^64 - 1.
 */
